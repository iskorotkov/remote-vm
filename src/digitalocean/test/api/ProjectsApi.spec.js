...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.ProjectsApi();
  });
  ...
  describe('(package)', function() {
    describe('ProjectsApi', function() {
      describe('createProject', function() {
        it('should call createProject successfully', function(done) {
          ...
          instance.createProject(body, function(error, data, response) {
            ...
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20114);
      ...
      describe('getDefaultProject', function() {
        it('should call getDefaultProject successfully', function(done) {
          // TODO: uncomment getDefaultProject call and complete the assertions
          /*

          instance.getDefaultProject(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20042);
      ...
      describe('listProjects', function() {
        it('should call listProjects successfully', function(done) {
          // TODO: uncomment listProjects call and complete the assertions
          /*

          instance.listProjects(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20041);
      ...
      describe('patchDefaultProject', function() {
        it('should call patchDefaultProject successfully', function(done) {
          // TODO: uncomment, update parameter values for patchDefaultProject call and complete the assertions
          /*

          instance.patchDefaultProject(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('patchProject', function() {
        it('should call patchProject successfully', function(done) {
          ...
          instance.patchProject(body, projectId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateDefaultProject', function() {
        it('should call updateDefaultProject successfully', function(done) {
          // TODO: uncomment, update parameter values for updateDefaultProject call and complete the assertions
          /*

          instance.updateDefaultProject(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateProject', function() {
        it('should call updateProject successfully', function(done) {
          ...
          instance.updateProject(body, projectId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
