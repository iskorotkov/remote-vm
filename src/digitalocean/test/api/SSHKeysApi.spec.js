...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.SSHKeysApi();
  });

  describe('(package)', function() {
    describe('SSHKeysApi', function() {
      describe('createSshKey', function() {
        it('should call createSshKey successfully', function(done) {
          // TODO: uncomment, update parameter values for createSshKey call and complete the assertions
          /*

          instance.createSshKey(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse201);
      ...
      describe('destroySshKey', function() {
        it('should call destroySshKey successfully', function(done) {
          // TODO: uncomment, update parameter values for destroySshKey call
          /*

          instance.destroySshKey(sshKeyIdentifier, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getSshKey', function() {
        it('should call getSshKey successfully', function(done) {
          // TODO: uncomment, update parameter values for getSshKey call and complete the assertions
          /*

          instance.getSshKey(sshKeyIdentifier, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listAllKeys', function() {
        it('should call listAllKeys successfully', function(done) {
          // TODO: uncomment, update parameter values for listAllKeys call and complete the assertions
          /*
          var opts = {};

          instance.listAllKeys(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse2003);
      ...
      describe('updateSshKey', function() {
        it('should call updateSshKey successfully', function(done) {
          // TODO: uncomment, update parameter values for updateSshKey call and complete the assertions
          /*

          instance.updateSshKey(body, sshKeyIdentifier, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
