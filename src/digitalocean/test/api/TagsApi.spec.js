...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.TagsApi();
  });

  describe('(package)', function() {
    describe('TagsApi', function() {
      describe('createNewTag', function() {
        it('should call createNewTag successfully', function(done) {
          // TODO: uncomment, update parameter values for createNewTag call and complete the assertions
          /*

          instance.createNewTag(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20115);
      ...
      describe('deleteTag', function() {
        it('should call deleteTag successfully', function(done) {
          ...
          instance.deleteTag(tagId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getTag', function() {
        it('should call getTag successfully', function(done) {
          ...
          instance.getTag(tagId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20056);
      ...
      describe('listAllTags', function() {
        it('should call listAllTags successfully', function(done) {
          // TODO: uncomment listAllTags call and complete the assertions
          /*

          instance.listAllTags(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20055);
      ...
      describe('tagResource', function() {
        it('should call tagResource successfully', function(done) {
          // TODO: uncomment, update parameter values for tagResource call
          /*

          instance.tagResource(body, tagId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('untagResource', function() {
        it('should call untagResource successfully', function(done) {
          // TODO: uncomment, update parameter values for untagResource call
          /*

          instance.untagResource(body, tagId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
