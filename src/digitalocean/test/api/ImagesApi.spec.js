...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.ImagesApi();
  });

  describe('(package)', function() {
    describe('ImagesApi', function() {
      describe('createCustomImage', function() {
        it('should call createCustomImage successfully', function(done) {
          // TODO: uncomment, update parameter values for createCustomImage call and complete the assertions
          /*

          instance.createCustomImage(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse2023);
      ...
      describe('deleteImage', function() {
        it('should call deleteImage successfully', function(done) {
          ...
          instance.deleteImage(imageId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getImage', function() {
        it('should call getImage successfully', function(done) {
          // TODO: uncomment, update parameter values for getImage call and complete the assertions
          /*

          instance.getImage(imageId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20034);
      ...
      describe('getImagesList', function() {
        it('should call getImagesList successfully', function(done) {
          // TODO: uncomment, update parameter values for getImagesList call and complete the assertions
          /*
          var opts = {};

          instance.getImagesList(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20033);
      ...
      describe('updateImage', function() {
        it('should call updateImage successfully', function(done) {
          // TODO: uncomment, update parameter values for updateImage call and complete the assertions
          /*

          instance.updateImage(body, imageId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
