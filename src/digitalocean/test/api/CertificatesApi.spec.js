...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.CertificatesApi();
  });

  describe('(package)', function() {
    describe('CertificatesApi', function() {
      describe('createCertificates', function() {
        it('should call createCertificates successfully', function(done) {
          // TODO: uncomment, update parameter values for createCertificates call and complete the assertions
          /*

          instance.createCertificates(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse2012);
      ...
      describe('deleteCertificate', function() {
        it('should call deleteCertificate successfully', function(done) {
          ...
          instance.deleteCertificate(certificateId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getCertificate', function() {
        it('should call getCertificate successfully', function(done) {
          ...
          instance.getCertificate(certificateId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listCertificates', function() {
        it('should call listCertificates successfully', function(done) {
          // TODO: uncomment, update parameter values for listCertificates call and complete the assertions
          /*
          var opts = {};

          instance.listCertificates(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse2007);
