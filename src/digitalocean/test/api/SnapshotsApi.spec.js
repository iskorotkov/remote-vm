...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.SnapshotsApi();
  });
    ...
    describe('SnapshotsApi', function() {
      describe('deleteSnapshot', function() {
        it('should call deleteSnapshot successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteSnapshot call
          /*

          instance.deleteSnapshot(snapshotId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getSnapshot', function() {
        it('should call getSnapshot successfully', function(done) {
          // TODO: uncomment, update parameter values for getSnapshot call and complete the assertions
          /*

          instance.getSnapshot(snapshotId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20054);
      ...
      describe('listAllSnapshots', function() {
        it('should call listAllSnapshots successfully', function(done) {
          // TODO: uncomment, update parameter values for listAllSnapshots call and complete the assertions
          /*
          var opts = {};

          instance.listAllSnapshots(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20053);
