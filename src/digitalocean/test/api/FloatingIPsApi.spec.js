...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.FloatingIPsApi();
  });

  describe('(package)', function() {
    describe('FloatingIPsApi', function() {
      describe('createFloatingIp', function() {
        it('should call createFloatingIp successfully', function(done) {
          // TODO: uncomment, update parameter values for createFloatingIp call and complete the assertions
          /*

          instance.createFloatingIp(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse2022);
      ...
      describe('deleteFloatingIp', function() {
        it('should call deleteFloatingIp successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteFloatingIp call
          /*

          instance.deleteFloatingIp(floatingIp, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getFloatingIp', function() {
        it('should call getFloatingIp successfully', function(done) {
          // TODO: uncomment, update parameter values for getFloatingIp call and complete the assertions
          /*

          instance.getFloatingIp(floatingIp, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20031);
      ...
      describe('listFloatingIps', function() {
        it('should call listFloatingIps successfully', function(done) {
          // TODO: uncomment listFloatingIps call and complete the assertions
          /*

          instance.listFloatingIps(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20030);
