...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.ImageActionsApi();
  });

  describe('(package)', function() {
    describe('ImageActionsApi', function() {
      describe('getImageAction', function() {
        it('should call getImageAction successfully', function(done) {
          // TODO: uncomment, update parameter values for getImageAction call and complete the assertions
          /*

          instance.getImageAction(imageId, actionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.Action);
      ...
      describe('listImageActions', function() {
        it('should call listImageActions successfully', function(done) {
          // TODO: uncomment, update parameter values for listImageActions call and complete the assertions
          /*

          instance.listImageActions(imageId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('postImageAction', function() {
        it('should call postImageAction successfully', function(done) {
          // TODO: uncomment, update parameter values for postImageAction call and complete the assertions
          /*
          var opts = {};

          instance.postImageAction(imageId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
