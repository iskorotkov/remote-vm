...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.DomainsApi();
  });
    ...
    describe('DomainsApi', function() {
      describe('createDomain', function() {
        it('should call createDomain successfully', function(done) {
          ...
          instance.createDomain(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse2018);
      ...
      describe('deleteDomain', function() {
        it('should call deleteDomain successfully', function(done) {
          ...
          instance.deleteDomain(domainName, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getDomain', function() {
        it('should call getDomain successfully', function(done) {
          // TODO: uncomment, update parameter values for getDomain call and complete the assertions
          /*

          instance.getDomain(domainName, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20019);
      ...
      describe('listAllDomains', function() {
        it('should call listAllDomains successfully', function(done) {
          // TODO: uncomment listAllDomains call and complete the assertions
          /*

          instance.listAllDomains(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20018);
