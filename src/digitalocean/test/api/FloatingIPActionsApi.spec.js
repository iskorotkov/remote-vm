...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanApi.FloatingIPActionsApi();
  });

  describe('(package)', function() {
    describe('FloatingIPActionsApi', function() {
      describe('getFloatingIpAction', function() {
        it('should call getFloatingIpAction successfully', function(done) {
          // TODO: uncomment, update parameter values for getFloatingIpAction call and complete the assertions
          /*

          instance.getFloatingIpAction(floatingIp, actionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20111);
      ...
      describe('listFloatingIpActions', function() {
        it('should call listFloatingIpActions successfully', function(done) {
          // TODO: uncomment, update parameter values for listFloatingIpActions call and complete the assertions
          /*

          instance.listFloatingIpActions(floatingIp, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(DigitalOceanApi.InlineResponse20032);
      ...
      describe('postFloatingIpAction', function() {
        it('should call postFloatingIpAction successfully', function(done) {
          // TODO: uncomment, update parameter values for postFloatingIpAction call and complete the assertions
          /*
          var opts = {};

          instance.postFloatingIpAction(floatingIp, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
