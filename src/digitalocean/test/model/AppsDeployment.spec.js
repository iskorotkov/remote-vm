...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppsDeployment', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.AppsDeployment();
      });

      it('should create an instance of AppsDeployment', function() {
        // TODO: update the code to test AppsDeployment
        expect(instance).to.be.a(DigitalOceanApi.AppsDeployment);
      });
      ...
      it('should have the property clonedFrom (base name: "cloned_from")', function() {
        // TODO: update the code to test the property clonedFrom
        expect(instance).to.have.property('clonedFrom');
        // expect(instance.clonedFrom).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property phaseLastUpdatedAt (base name: "phase_last_updated_at")', function() {
        // TODO: update the code to test the property phaseLastUpdatedAt
        expect(instance).to.have.property('phaseLastUpdatedAt');
        // expect(instance.phaseLastUpdatedAt).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property staticSites (base name: "static_sites")', function() {
        // TODO: update the code to test the property staticSites
        expect(instance).to.have.property('staticSites');
        // expect(instance.staticSites).to.be(expectedValueLiteral);
      });
