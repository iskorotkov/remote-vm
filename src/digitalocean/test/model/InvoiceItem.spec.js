...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceItem', function() {
      ...
      it('should have the property resourceUuid (base name: "resource_uuid")', function() {
        // TODO: update the code to test the property resourceUuid
        expect(instance).to.have.property('resourceUuid');
        // expect(instance.resourceUuid).to.be(expectedValueLiteral);
      });
