...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSummary', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.InvoiceSummary();
      });

      it('should create an instance of InvoiceSummary', function() {
        // TODO: update the code to test InvoiceSummary
        expect(instance).to.be.a(DigitalOceanApi.InvoiceSummary);
      });

      it('should have the property invoiceUuid (base name: "invoice_uuid")', function() {
        // TODO: update the code to test the property invoiceUuid
        expect(instance).to.have.property('invoiceUuid');
        // expect(instance.invoiceUuid).to.be(expectedValueLiteral);
      });

      it('should have the property billingPeriod (base name: "billing_period")', function() {
        // TODO: update the code to test the property billingPeriod
        expect(instance).to.have.property('billingPeriod');
        // expect(instance.billingPeriod).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property userBillingAddress (base name: "user_billing_address")', function() {
        // TODO: update the code to test the property userBillingAddress
        expect(instance).to.have.property('userBillingAddress');
        // expect(instance.userBillingAddress).to.be(expectedValueLiteral);
      });

      it('should have the property userCompany (base name: "user_company")', function() {
        // TODO: update the code to test the property userCompany
        expect(instance).to.have.property('userCompany');
        // expect(instance.userCompany).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property productCharges (base name: "product_charges")', function() {
        // TODO: update the code to test the property productCharges
        expect(instance).to.have.property('productCharges');
        // expect(instance.productCharges).to.be(expectedValueLiteral);
      });

      it('should have the property overages (base name: "overages")', function() {
        // TODO: update the code to test the property overages
        expect(instance).to.have.property('overages');
        // expect(instance.overages).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property creditsAndAdjustments (base name: "credits_and_adjustments")', function() {
        // TODO: update the code to test the property creditsAndAdjustments
        expect(instance).to.have.property('creditsAndAdjustments');
        // expect(instance.creditsAndAdjustments).to.be(expectedValueLiteral);
      });
