...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesNodePool', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.KubernetesNodePool();
      });

      it('should create an instance of KubernetesNodePool', function() {
        // TODO: update the code to test KubernetesNodePool
        expect(instance).to.be.a(DigitalOceanApi.KubernetesNodePool);
      });
