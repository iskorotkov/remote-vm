...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesNodePoolBase', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.KubernetesNodePoolBase();
      });

      it('should create an instance of KubernetesNodePoolBase', function() {
        // TODO: update the code to test KubernetesNodePoolBase
        expect(instance).to.be.a(DigitalOceanApi.KubernetesNodePoolBase);
      });
      ...
      it('should have the property taints (base name: "taints")', function() {
        // TODO: update the code to test the property taints
        expect(instance).to.have.property('taints');
        // expect(instance.taints).to.be(expectedValueLiteral);
      });

      it('should have the property autoScale (base name: "auto_scale")', function() {
        // TODO: update the code to test the property autoScale
        expect(instance).to.have.property('autoScale');
        // expect(instance.autoScale).to.be(expectedValueLiteral);
      });

      it('should have the property minNodes (base name: "min_nodes")', function() {
        // TODO: update the code to test the property minNodes
        expect(instance).to.have.property('minNodes');
        // expect(instance.minNodes).to.be(expectedValueLiteral);
      });

      it('should have the property maxNodes (base name: "max_nodes")', function() {
        // TODO: update the code to test the property maxNodes
        expect(instance).to.have.property('maxNodes');
        // expect(instance.maxNodes).to.be(expectedValueLiteral);
      });
