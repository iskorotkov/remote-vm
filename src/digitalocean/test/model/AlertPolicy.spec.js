...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AlertPolicy', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.AlertPolicy();
      });

      it('should create an instance of AlertPolicy', function() {
        // TODO: update the code to test AlertPolicy
        expect(instance).to.be.a(DigitalOceanApi.AlertPolicy);
      });
      ...
      it('should have the property compare (base name: "compare")', function() {
        // TODO: update the code to test the property compare
        expect(instance).to.have.property('compare');
        // expect(instance.compare).to.be(expectedValueLiteral);
      });
