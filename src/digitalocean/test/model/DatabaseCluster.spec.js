...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DatabaseCluster', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.DatabaseCluster();
      });

      it('should create an instance of DatabaseCluster', function() {
        // TODO: update the code to test DatabaseCluster
        expect(instance).to.be.a(DigitalOceanApi.DatabaseCluster);
      });
      ...
      it('should have the property numNodes (base name: "num_nodes")', function() {
        // TODO: update the code to test the property numNodes
        expect(instance).to.have.property('numNodes');
        // expect(instance.numNodes).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property privateNetworkUuid (base name: "private_network_uuid")', function() {
        // TODO: update the code to test the property privateNetworkUuid
        expect(instance).to.have.property('privateNetworkUuid');
        // expect(instance.privateNetworkUuid).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property dbNames (base name: "db_names")', function() {
        // TODO: update the code to test the property dbNames
        expect(instance).to.have.property('dbNames');
        // expect(instance.dbNames).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property privateConnection (base name: "private_connection")', function() {
        // TODO: update the code to test the property privateConnection
        expect(instance).to.have.property('privateConnection');
        // expect(instance.privateConnection).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property maintenanceWindow (base name: "maintenance_window")', function() {
        // TODO: update the code to test the property maintenanceWindow
        expect(instance).to.have.property('maintenanceWindow');
        // expect(instance.maintenanceWindow).to.be(expectedValueLiteral);
      });
