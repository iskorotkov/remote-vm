...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LoadBalancerBase', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.LoadBalancerBase();
      });

      it('should create an instance of LoadBalancerBase', function() {
        // TODO: update the code to test LoadBalancerBase
        expect(instance).to.be.a(DigitalOceanApi.LoadBalancerBase);
      });
      ...
      it('should have the property forwardingRules (base name: "forwarding_rules")', function() {
        // TODO: update the code to test the property forwardingRules
        expect(instance).to.have.property('forwardingRules');
        // expect(instance.forwardingRules).to.be(expectedValueLiteral);
      });

      it('should have the property healthCheck (base name: "health_check")', function() {
      ...
      it('should have the property stickySessions (base name: "sticky_sessions")', function() {
        // TODO: update the code to test the property stickySessions
        expect(instance).to.have.property('stickySessions');
        // expect(instance.stickySessions).to.be(expectedValueLiteral);
      });

      it('should have the property redirectHttpToHttps (base name: "redirect_http_to_https")', function() {
        // TODO: update the code to test the property redirectHttpToHttps
        expect(instance).to.have.property('redirectHttpToHttps');
        // expect(instance.redirectHttpToHttps).to.be(expectedValueLiteral);
      });

      it('should have the property enableProxyProtocol (base name: "enable_proxy_protocol")', function() {
        // TODO: update the code to test the property enableProxyProtocol
        expect(instance).to.have.property('enableProxyProtocol');
        // expect(instance.enableProxyProtocol).to.be(expectedValueLiteral);
      });

      it('should have the property enableBackendKeepalive (base name: "enable_backend_keepalive")', function() {
        // TODO: update the code to test the property enableBackendKeepalive
        expect(instance).to.have.property('enableBackendKeepalive');
        // expect(instance.enableBackendKeepalive).to.be(expectedValueLiteral);
      });
