  ...
  describe('(package)', function() {
    describe('Image', function() {
      ...
      it('should have the property distribution (base name: "distribution")', function() {
        // TODO: update the code to test the property distribution
        expect(instance).to.have.property('distribution');
        // expect(instance.distribution).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property minDiskSize (base name: "min_disk_size")', function() {
        // TODO: update the code to test the property minDiskSize
        expect(instance).to.have.property('minDiskSize');
        // expect(instance.minDiskSize).to.be(expectedValueLiteral);
      });

      it('should have the property sizeGigabytes (base name: "size_gigabytes")', function() {
        // TODO: update the code to test the property sizeGigabytes
        expect(instance).to.have.property('sizeGigabytes');
        // expect(instance.sizeGigabytes).to.be(expectedValueLiteral);
      });
