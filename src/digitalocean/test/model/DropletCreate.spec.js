...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DropletCreate', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.DropletCreate();
      });

      it('should create an instance of DropletCreate', function() {
        // TODO: update the code to test DropletCreate
        expect(instance).to.be.a(DigitalOceanApi.DropletCreate);
      });
