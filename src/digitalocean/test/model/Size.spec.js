...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Size', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.Size();
      });

      it('should create an instance of Size', function() {
        // TODO: update the code to test Size
        expect(instance).to.be.a(DigitalOceanApi.Size);
      });
      ...
      it('should have the property priceMonthly (base name: "price_monthly")', function() {
        // TODO: update the code to test the property priceMonthly
        expect(instance).to.have.property('priceMonthly');
        // expect(instance.priceMonthly).to.be(expectedValueLiteral);
      });

      it('should have the property priceHourly (base name: "price_hourly")', function() {
        // TODO: update the code to test the property priceHourly
        expect(instance).to.have.property('priceHourly');
        // expect(instance.priceHourly).to.be(expectedValueLiteral);
      });
