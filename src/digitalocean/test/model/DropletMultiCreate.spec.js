...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DropletMultiCreate', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.DropletMultiCreate();
      });

      it('should create an instance of DropletMultiCreate', function() {
        // TODO: update the code to test DropletMultiCreate
        expect(instance).to.be.a(DigitalOceanApi.DropletMultiCreate);
      });
