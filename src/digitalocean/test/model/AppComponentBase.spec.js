...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppComponentBase', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.AppComponentBase();
      });

      it('should create an instance of AppComponentBase', function() {
        // TODO: update the code to test AppComponentBase
        expect(instance).to.be.a(DigitalOceanApi.AppComponentBase);
      });
      ...
      it('should have the property github (base name: "github")', function() {
        // TODO: update the code to test the property github
        expect(instance).to.have.property('github');
        // expect(instance.github).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property dockerfilePath (base name: "dockerfile_path")', function() {
        // TODO: update the code to test the property dockerfilePath
        expect(instance).to.have.property('dockerfilePath');
        // expect(instance.dockerfilePath).to.be(expectedValueLiteral);
      });

      it('should have the property buildCommand (base name: "build_command")', function() {
        // TODO: update the code to test the property buildCommand
        expect(instance).to.have.property('buildCommand');
        // expect(instance.buildCommand).to.be(expectedValueLiteral);
      });

      it('should have the property runCommand (base name: "run_command")', function() {
        // TODO: update the code to test the property runCommand
        expect(instance).to.have.property('runCommand');
        // expect(instance.runCommand).to.be(expectedValueLiteral);
      });

      it('should have the property sourceDir (base name: "source_dir")', function() {
        // TODO: update the code to test the property sourceDir
        expect(instance).to.have.property('sourceDir');
        // expect(instance.sourceDir).to.be(expectedValueLiteral);
      });

      it('should have the property envs (base name: "envs")', function() {
        // TODO: update the code to test the property envs
        expect(instance).to.have.property('envs');
        // expect(instance.envs).to.be(expectedValueLiteral);
      });

      it('should have the property environmentSlug (base name: "environment_slug")', function() {
        // TODO: update the code to test the property environmentSlug
        expect(instance).to.have.property('environmentSlug');
        // expect(instance.environmentSlug).to.be(expectedValueLiteral);
      });
