...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DropletSingleCreate', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.DropletSingleCreate();
      });

      it('should create an instance of DropletSingleCreate', function() {
        // TODO: update the code to test DropletSingleCreate
        expect(instance).to.be.a(DigitalOceanApi.DropletSingleCreate);
      });
      ...
      it('should have the property sshKeys (base name: "ssh_keys")', function() {
        // TODO: update the code to test the property sshKeys
        expect(instance).to.have.property('sshKeys');
        // expect(instance.sshKeys).to.be(expectedValueLiteral);
      });

      it('should have the property backups (base name: "backups")', function() {
        // TODO: update the code to test the property backups
        expect(instance).to.have.property('backups');
        // expect(instance.backups).to.be(expectedValueLiteral);
      });

      it('should have the property ipv6 (base name: "ipv6")', function() {
        // TODO: update the code to test the property ipv6
        expect(instance).to.have.property('ipv6');
        // expect(instance.ipv6).to.be(expectedValueLiteral);
      });

      it('should have the property monitoring (base name: "monitoring")', function() {
        // TODO: update the code to test the property monitoring
        expect(instance).to.have.property('monitoring');
        // expect(instance.monitoring).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property privateNetworking (base name: "private_networking")', function() {
        // TODO: update the code to test the property privateNetworking
        expect(instance).to.have.property('privateNetworking');
        // expect(instance.privateNetworking).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property withDropletAgent (base name: "with_droplet_agent")', function() {
        // TODO: update the code to test the property withDropletAgent
        expect(instance).to.have.property('withDropletAgent');
        // expect(instance.withDropletAgent).to.be(expectedValueLiteral);
      });
