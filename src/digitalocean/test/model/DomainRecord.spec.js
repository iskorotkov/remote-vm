...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DomainRecord', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.DomainRecord();
      });

      it('should create an instance of DomainRecord', function() {
        // TODO: update the code to test DomainRecord
        expect(instance).to.be.a(DigitalOceanApi.DomainRecord);
      });
