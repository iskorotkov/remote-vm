...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Distribution', function() {
      beforeEach(function() {
        instance = DigitalOceanApi.Distribution;
      });
      ...
      it('should have the property archLinux', function() {
        expect(instance).to.have.property('archLinux');
        expect(instance.archLinux).to.be("Arch Linux");
      });

      it('should have the property centOS', function() {
        expect(instance).to.have.property('centOS');
        expect(instance.centOS).to.be("CentOS");
      });

      it('should have the property coreOS', function() {
        expect(instance).to.have.property('coreOS');
        expect(instance.coreOS).to.be("CoreOS");
      });

      it('should have the property debian', function() {
        expect(instance).to.have.property('debian');
        expect(instance.debian).to.be("Debian");
      });

      it('should have the property fedora', function() {
        expect(instance).to.have.property('fedora');
        expect(instance.fedora).to.be("Fedora");
      });

      it('should have the property fedoraAtomic', function() {
        expect(instance).to.have.property('fedoraAtomic');
        expect(instance.fedoraAtomic).to.be("Fedora Atomic");
      });

      it('should have the property freeBSD', function() {
        expect(instance).to.have.property('freeBSD');
        expect(instance.freeBSD).to.be("FreeBSD");
      });

      it('should have the property gentoo', function() {
        expect(instance).to.have.property('gentoo');
        expect(instance.gentoo).to.be("Gentoo");
      });

      it('should have the property openSUSE', function() {
        expect(instance).to.have.property('openSUSE');
        expect(instance.openSUSE).to.be("openSUSE");
      });

      it('should have the property rancherOS', function() {
        expect(instance).to.have.property('rancherOS');
        expect(instance.rancherOS).to.be("RancherOS");
      });

      it('should have the property ubuntu', function() {
        expect(instance).to.have.property('ubuntu');
        expect(instance.ubuntu).to.be("Ubuntu");
      });
