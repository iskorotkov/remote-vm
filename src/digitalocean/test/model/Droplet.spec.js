...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Droplet', function() {
      beforeEach(function() {
        instance = new DigitalOceanApi.Droplet();
      });

      it('should create an instance of Droplet', function() {
        // TODO: update the code to test Droplet
        expect(instance).to.be.a(DigitalOceanApi.Droplet);
      });
      ...
      it('should have the property vcpus (base name: "vcpus")', function() {
        // TODO: update the code to test the property vcpus
        expect(instance).to.have.property('vcpus');
        // expect(instance.vcpus).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property kernel (base name: "kernel")', function() {
        // TODO: update the code to test the property kernel
        expect(instance).to.have.property('kernel');
        // expect(instance.kernel).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property backupIds (base name: "backup_ids")', function() {
        // TODO: update the code to test the property backupIds
        expect(instance).to.have.property('backupIds');
        // expect(instance.backupIds).to.be(expectedValueLiteral);
      });

      it('should have the property nextBackupWindow (base name: "next_backup_window")', function() {
        // TODO: update the code to test the property nextBackupWindow
        expect(instance).to.have.property('nextBackupWindow');
        // expect(instance.nextBackupWindow).to.be(expectedValueLiteral);
      });

      it('should have the property snapshotIds (base name: "snapshot_ids")', function() {
        // TODO: update the code to test the property snapshotIds
        expect(instance).to.have.property('snapshotIds');
        // expect(instance.snapshotIds).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property volumeIds (base name: "volume_ids")', function() {
        // TODO: update the code to test the property volumeIds
        expect(instance).to.have.property('volumeIds');
        // expect(instance.volumeIds).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property sizeSlug (base name: "size_slug")', function() {
        // TODO: update the code to test the property sizeSlug
        expect(instance).to.have.property('sizeSlug');
        // expect(instance.sizeSlug).to.be(expectedValueLiteral);
      });
