...
export const AccountApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserInformation: async (options: any = {}): Promise<RequestArgs> => {
...
export const AccountApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserInformation(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002>> {
            const localVarAxiosArgs = await AccountApiAxiosParamCreator(configuration).getUserInformation(options);
...
export const AccountApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUserInformation(options?: any): AxiosPromise<InlineResponse2002> {
            return AccountApiFp(configuration).getUserInformation(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AccountApi extends BaseAPI {
     ...
     * @memberof AccountApi
     */
    public getUserInformation(options?: any) {
        return AccountApiFp(this.configuration).getUserInformation(options).then((request) => request(this.axios, this.basePath));
    }
}
