...
import { ImageId } from '../models';
import { ImageNewCustom } from '../models';
import { ImageUpdate } from '../models';
...
export const ImagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ImageNewCustom} body
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createCustomImage: async (body: ImageNewCustom, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling createCustomImage.');
            }
        ...
        deleteImage: async (imageId: number, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v2/images/{image_id}`
         ...
         * @param {ImageId} imageId A unique number (id) or string (slug) used to identify and reference a specific image.  **Public** images can be identified by image &#x60;id&#x60; or &#x60;slug&#x60;.  **Private** images *must* be identified by image &#x60;id&#x60;.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getImage: async (imageId: ImageId, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'imageId' is not null or undefined
            if (imageId === null || imageId === undefined) {
         ...
         * @param {string} [type] Filters results based on image type which can be either &#x60;application&#x60; or &#x60;distribution&#x60;.
         * @param {boolean} [_private] Used to filter only user images.
         * @param {string} [tagName] Used to filter images by a specific tag.
         * @param {number} [perPage] Number of items returned per page
         * @param {number} [page] Which &#x27;page&#x27; of paginated results to return.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getImagesList: async (type?: string, _private?: boolean, tagName?: string, perPage?: number, page?: number, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/images`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @param {ImageUpdate} body
         * @param {number} imageId A unique number that can be used to identify and reference a specific image.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateImage: async (body: ImageUpdate, imageId: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling updateImage.');
            }
            // verify required parameter 'imageId' is not null or undefined
            if (imageId === null || imageId === undefined) {
...
export const ImagesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createCustomImage(body: ImageNewCustom, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2023>> {
            const localVarAxiosArgs = await ImagesApiAxiosParamCreator(configuration).createCustomImage(body, options);
        ...
        async deleteImage(imageId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await ImagesApiAxiosParamCreator(configuration).deleteImage(imageId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getImage(imageId: ImageId, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20034>> {
            const localVarAxiosArgs = await ImagesApiAxiosParamCreator(configuration).getImage(imageId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getImagesList(type?: string, _private?: boolean, tagName?: string, perPage?: number, page?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20033>> {
            const localVarAxiosArgs = await ImagesApiAxiosParamCreator(configuration).getImagesList(type, _private, tagName, perPage, page, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateImage(body: ImageUpdate, imageId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20034>> {
            const localVarAxiosArgs = await ImagesApiAxiosParamCreator(configuration).updateImage(body, imageId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ImagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createCustomImage(body: ImageNewCustom, options?: any): AxiosPromise<InlineResponse2023> {
            return ImagesApiFp(configuration).createCustomImage(body, options).then((request) => request(axios, basePath));
        },
        /**
         * To delete a snapshot or custom image, send a `DELETE` request to `/v2/images/$IMAGE_ID`.
         * @summary Delete an Image
        ...
        deleteImage(imageId: number, options?: any): AxiosPromise<void> {
            return ImagesApiFp(configuration).deleteImage(imageId, options).then((request) => request(axios, basePath));
        },
        /**
         * To retrieve information about an image, send a `GET` request to `/v2/images/$IDENTIFIER`.
         * @summary Retrieve an Existing Image
         ...
         * @throws {RequiredError}
         */
        getImage(imageId: ImageId, options?: any): AxiosPromise<InlineResponse20034> {
            return ImagesApiFp(configuration).getImage(imageId, options).then((request) => request(axios, basePath));
        },
        /**
         * To list all of the images available on your account, send a GET request to /v2/images.  ## Filtering Results -----  It's possible to request filtered results by including certain query parameters.  **Image Type**  Either 1-Click Application or OS Distribution images can be filtered by using the `type` query parameter.  > Important: The `type` query parameter does not directly relate to the `type` attribute.  To retrieve only ***distribution*** images, include the `type` query parameter set to distribution, `/v2/images?type=distribution`.  To retrieve only ***application*** images, include the `type` query parameter set to application, `/v2/images?type=application`.  **User Images**  To retrieve only the private images of a user, include the `private` query parameter set to true, `/v2/images?private=true`.  **Tags**  To list all images assigned to a specific tag, include the `tag_name` query parameter set to the name of the tag in your GET request. For example, `/v2/images?tag_name=$TAG_NAME`.
         * @summary List All Images
         ...
         * @throws {RequiredError}
         */
        getImagesList(type?: string, _private?: boolean, tagName?: string, perPage?: number, page?: number, options?: any): AxiosPromise<InlineResponse20033> {
            return ImagesApiFp(configuration).getImagesList(type, _private, tagName, perPage, page, options).then((request) => request(axios, basePath));
        },
        /**
         * To update an image, send a `PUT` request to `/v2/images/$IMAGE_ID`. Set the `name` attribute to the new value you would like to use. For custom images, the `description` and `distribution` attributes may also be updated.
         * @summary Update an Image
         ...
         * @throws {RequiredError}
         */
        updateImage(body: ImageUpdate, imageId: number, options?: any): AxiosPromise<InlineResponse20034> {
            return ImagesApiFp(configuration).updateImage(body, imageId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ImagesApi extends BaseAPI {
     ...
     * @memberof ImagesApi
     */
    public createCustomImage(body: ImageNewCustom, options?: any) {
        return ImagesApiFp(this.configuration).createCustomImage(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To delete a snapshot or custom image, send a `DELETE` request to `/v2/images/$IMAGE_ID`.
     * @summary Delete an Image
    ...
    public deleteImage(imageId: number, options?: any) {
        return ImagesApiFp(this.configuration).deleteImage(imageId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To retrieve information about an image, send a `GET` request to `/v2/images/$IDENTIFIER`.
     * @summary Retrieve an Existing Image
     ...
     * @memberof ImagesApi
     */
    public getImage(imageId: ImageId, options?: any) {
     ...
     * @memberof ImagesApi
     */
    public getImagesList(type?: string, _private?: boolean, tagName?: string, perPage?: number, page?: number, options?: any) {
        return ImagesApiFp(this.configuration).getImagesList(type, _private, tagName, perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To update an image, send a `PUT` request to `/v2/images/$IMAGE_ID`. Set the `name` attribute to the new value you would like to use. For custom images, the `description` and `distribution` attributes may also be updated.
     * @summary Update an Image
     ...
     * @memberof ImagesApi
     */
    public updateImage(body: ImageUpdate, imageId: number, options?: any) {
        return ImagesApiFp(this.configuration).updateImage(body, imageId, options).then((request) => request(this.axios, this.basePath));
    }
}
