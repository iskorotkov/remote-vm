...
import { ProjectsDefaultBody } from '../models';
import { ProjectsProjectIdBody } from '../models';
import { V2ProjectsBody } from '../models';
...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2ProjectsBody} body
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProject: async (body: V2ProjectsBody, options: any = {}): Promise<RequestArgs> => {
        ...
        deleteProject: async (projectId: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v2/projects/{project_id}`
         ...
         * @throws {RequiredError}
         */
        getDefaultProject: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/projects/default`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        listProjects: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/projects`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        patchDefaultProject: async (body: Project, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling patchDefaultProject.');
            }
            const localVarPath = `/v2/projects/default`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
         ...
         * @throws {RequiredError}
         */
        patchProject: async (body: Project, projectId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
            ...
            // verify required parameter 'projectId' is not null or undefined
            if (projectId === null || projectId === undefined) {
                throw new RequiredError('projectId','Required parameter projectId was null or undefined when calling patchProject.');
            }
            const localVarPath = `/v2/projects/{project_id}`
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @param {ProjectsDefaultBody} body
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateDefaultProject: async (body: ProjectsDefaultBody, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling updateDefaultProject.');
            }
            const localVarPath = `/v2/projects/default`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
         ...
         * @throws {RequiredError}
         */
        updateProject: async (body: ProjectsProjectIdBody, projectId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ProjectsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createProject(body: V2ProjectsBody, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20114>> {
         ...
         * @throws {RequiredError}
         */
        async getDefaultProject(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20042>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).getDefaultProject(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getProject(projectId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20114>> {
         ...
         * @throws {RequiredError}
         */
        async listProjects(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20041>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).listProjects(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async patchDefaultProject(body: Project, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20114>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).patchDefaultProject(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async patchProject(body: Project, projectId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20114>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).patchProject(body, projectId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateDefaultProject(body: ProjectsDefaultBody, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20114>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).updateDefaultProject(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateProject(body: ProjectsProjectIdBody, projectId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20114>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).updateProject(body, projectId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ProjectsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createProject(body: V2ProjectsBody, options?: any): AxiosPromise<InlineResponse20114> {
         ...
         * @throws {RequiredError}
         */
        getDefaultProject(options?: any): AxiosPromise<InlineResponse20042> {
            return ProjectsApiFp(configuration).getDefaultProject(options).then((request) => request(axios, basePath));
        },
        /**
         * To get a project, send a GET request to `/v2/projects/$PROJECT_ID`.
         * @summary Retrieve an Existing Project
         ...
         * @throws {RequiredError}
         */
        getProject(projectId: string, options?: any): AxiosPromise<InlineResponse20114> {
         ...
         * @throws {RequiredError}
         */
        listProjects(options?: any): AxiosPromise<InlineResponse20041> {
            return ProjectsApiFp(configuration).listProjects(options).then((request) => request(axios, basePath));
        },
        /**
         * To update only specific attributes of a project, send a PATCH request to `/v2/projects/default`. At least one of the following attributes needs to be sent.
         * @summary Patch the Default Project
         ...
         * @throws {RequiredError}
         */
        patchDefaultProject(body: Project, options?: any): AxiosPromise<InlineResponse20114> {
            return ProjectsApiFp(configuration).patchDefaultProject(body, options).then((request) => request(axios, basePath));
        },
        /**
         * To update only specific attributes of a project, send a PATCH request to `/v2/projects/$PROJECT_ID`. At least one of the following attributes needs to be sent.
         * @summary Patch a Project
         ...
         * @throws {RequiredError}
         */
        patchProject(body: Project, projectId: string, options?: any): AxiosPromise<InlineResponse20114> {
            return ProjectsApiFp(configuration).patchProject(body, projectId, options).then((request) => request(axios, basePath));
        },
        /**
         * To update a project, send a PUT request to `/v2/projects/default`. All of the following attributes must be sent.
         * @summary Update the Default Project
         ...
         * @throws {RequiredError}
         */
        updateDefaultProject(body: ProjectsDefaultBody, options?: any): AxiosPromise<InlineResponse20114> {
            return ProjectsApiFp(configuration).updateDefaultProject(body, options).then((request) => request(axios, basePath));
        },
        /**
         * To update a project, send a PUT request to `/v2/projects/$PROJECT_ID`. All of the following attributes must be sent.
         * @summary Update a Project
         ...
         * @throws {RequiredError}
         */
        updateProject(body: ProjectsProjectIdBody, projectId: string, options?: any): AxiosPromise<InlineResponse20114> {
            return ProjectsApiFp(configuration).updateProject(body, projectId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ProjectsApi extends BaseAPI {
     ...
     */
    public createProject(body: V2ProjectsBody, options?: any) {
     ...
     * @memberof ProjectsApi
     */
    public getDefaultProject(options?: any) {
        return ProjectsApiFp(this.configuration).getDefaultProject(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To get a project, send a GET request to `/v2/projects/$PROJECT_ID`.
     * @summary Retrieve an Existing Project
     ...
     * @memberof ProjectsApi
     */
    public listProjects(options?: any) {
     ...
     * @memberof ProjectsApi
     */
    public patchDefaultProject(body: Project, options?: any) {
        return ProjectsApiFp(this.configuration).patchDefaultProject(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To update only specific attributes of a project, send a PATCH request to `/v2/projects/$PROJECT_ID`. At least one of the following attributes needs to be sent.
     * @summary Patch a Project
     ...
     * @memberof ProjectsApi
     */
    public patchProject(body: Project, projectId: string, options?: any) {
        return ProjectsApiFp(this.configuration).patchProject(body, projectId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To update a project, send a PUT request to `/v2/projects/default`. All of the following attributes must be sent.
     * @summary Update the Default Project
     ...
     * @memberof ProjectsApi
     */
    public updateDefaultProject(body: ProjectsDefaultBody, options?: any) {
        return ProjectsApiFp(this.configuration).updateDefaultProject(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To update a project, send a PUT request to `/v2/projects/$PROJECT_ID`. All of the following attributes must be sent.
     * @summary Update a Project
    ...
    public updateProject(body: ProjectsProjectIdBody, projectId: string, options?: any) {
        return ProjectsApiFp(this.configuration).updateProject(body, projectId, options).then((request) => request(this.axios, this.basePath));
    }
}
