...
export const SnapshotsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        deleteSnapshot: async (snapshotId: SnapshotId, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v2/snapshots/{snapshot_id}`
         ...
         * @throws {RequiredError}
         */
        getSnapshot: async (snapshotId: SnapshotId, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'snapshotId' is not null or undefined
            if (snapshotId === null || snapshotId === undefined) {
                throw new RequiredError('snapshotId','Required parameter snapshotId was null or undefined when calling getSnapshot.');
            }
            const localVarPath = `/v2/snapshots/{snapshot_id}`
                .replace(`{${"snapshot_id"}}`, encodeURIComponent(String(snapshotId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @param {string} [resourceType] Used to filter snapshots by a resource type.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listAllSnapshots: async (perPage?: number, page?: number, resourceType?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/snapshots`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const SnapshotsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteSnapshot(snapshotId: SnapshotId, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await SnapshotsApiAxiosParamCreator(configuration).deleteSnapshot(snapshotId, options);
         ...
         * @throws {RequiredError}
         */
        async getSnapshot(snapshotId: SnapshotId, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20054>> {
            const localVarAxiosArgs = await SnapshotsApiAxiosParamCreator(configuration).getSnapshot(snapshotId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listAllSnapshots(perPage?: number, page?: number, resourceType?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20053>> {
            const localVarAxiosArgs = await SnapshotsApiAxiosParamCreator(configuration).listAllSnapshots(perPage, page, resourceType, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SnapshotsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteSnapshot(snapshotId: SnapshotId, options?: any): AxiosPromise<void> {
            return SnapshotsApiFp(configuration).deleteSnapshot(snapshotId, options).then((request) => request(axios, basePath));
        },
        /**
         * To retrieve information about a snapshot, send a GET request to `/v2/snapshots/$SNAPSHOT_ID`.  The response will be a JSON object with a key called `snapshot`. The value of this will be an snapshot object containing the standard snapshot attributes.
         * @summary Retrieve an Existing Snapshot
         ...
         * @throws {RequiredError}
         */
        getSnapshot(snapshotId: SnapshotId, options?: any): AxiosPromise<InlineResponse20054> {
            return SnapshotsApiFp(configuration).getSnapshot(snapshotId, options).then((request) => request(axios, basePath));
        },
        /**
         * To list all of the snapshots available on your account, send a GET request to `/v2/snapshots`.  The response will be a JSON object with a key called `snapshots`. This will be set to an array of `snapshot` objects, each of which will contain the standard snapshot attributes.  ### Filtering Results by Resource Type  It's possible to request filtered results by including certain query parameters.  #### List Droplet Snapshots  To retrieve only snapshots based on Droplets, include the `resource_type` query parameter set to `droplet`. For example, `/v2/snapshots?resource_type=droplet`.  #### List Volume Snapshots  To retrieve only snapshots based on volumes, include the `resource_type` query parameter set to `volume`. For example, `/v2/snapshots?resource_type=volume`.
         * @summary List All Snapshots
         ...
         * @throws {RequiredError}
         */
        listAllSnapshots(perPage?: number, page?: number, resourceType?: string, options?: any): AxiosPromise<InlineResponse20053> {
            return SnapshotsApiFp(configuration).listAllSnapshots(perPage, page, resourceType, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SnapshotsApi extends BaseAPI {
     ...
     */
    public deleteSnapshot(snapshotId: SnapshotId, options?: any) {
        return SnapshotsApiFp(this.configuration).deleteSnapshot(snapshotId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To retrieve information about a snapshot, send a GET request to `/v2/snapshots/$SNAPSHOT_ID`.  The response will be a JSON object with a key called `snapshot`. The value of this will be an snapshot object containing the standard snapshot attributes.
     * @summary Retrieve an Existing Snapshot
     ...
     * @memberof SnapshotsApi
     */
    public getSnapshot(snapshotId: SnapshotId, options?: any) {
        return SnapshotsApiFp(this.configuration).getSnapshot(snapshotId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To list all of the snapshots available on your account, send a GET request to `/v2/snapshots`.  The response will be a JSON object with a key called `snapshots`. This will be set to an array of `snapshot` objects, each of which will contain the standard snapshot attributes.  ### Filtering Results by Resource Type  It's possible to request filtered results by including certain query parameters.  #### List Droplet Snapshots  To retrieve only snapshots based on Droplets, include the `resource_type` query parameter set to `droplet`. For example, `/v2/snapshots?resource_type=droplet`.  #### List Volume Snapshots  To retrieve only snapshots based on volumes, include the `resource_type` query parameter set to `volume`. For example, `/v2/snapshots?resource_type=volume`.
     * @summary List All Snapshots
     ...
     * @memberof SnapshotsApi
     */
    public listAllSnapshots(perPage?: number, page?: number, resourceType?: string, options?: any) {
        return SnapshotsApiFp(this.configuration).listAllSnapshots(perPage, page, resourceType, options).then((request) => request(this.axios, this.basePath));
    }
}
