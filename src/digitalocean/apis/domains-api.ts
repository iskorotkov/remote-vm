...
export const DomainsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createDomain: async (body?: Domain, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteDomain: async (domainName: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'domainName' is not null or undefined
            if (domainName === null || domainName === undefined) {
                throw new RequiredError('domainName','Required parameter domainName was null or undefined when calling deleteDomain.');
            }
            const localVarPath = `/v2/domains/{domain_name}`
         ...
         * @throws {RequiredError}
         */
        getDomain: async (domainName: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'domainName' is not null or undefined
            if (domainName === null || domainName === undefined) {
         ...
         * @throws {RequiredError}
         */
        listAllDomains: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/domains`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const DomainsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createDomain(body?: Domain, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2018>> {
            const localVarAxiosArgs = await DomainsApiAxiosParamCreator(configuration).createDomain(body, options);
         ...
         * @throws {RequiredError}
         */
        async deleteDomain(domainName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DomainsApiAxiosParamCreator(configuration).deleteDomain(domainName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getDomain(domainName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20019>> {
            const localVarAxiosArgs = await DomainsApiAxiosParamCreator(configuration).getDomain(domainName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listAllDomains(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20018>> {
            const localVarAxiosArgs = await DomainsApiAxiosParamCreator(configuration).listAllDomains(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DomainsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createDomain(body?: Domain, options?: any): AxiosPromise<InlineResponse2018> {
            return DomainsApiFp(configuration).createDomain(body, options).then((request) => request(axios, basePath));
        },
        /**
         * To delete a domain, send a DELETE request to `/v2/domains/$DOMAIN_NAME`.
         * @summary Delete a Domain
         ...
         * @throws {RequiredError}
         */
        deleteDomain(domainName: string, options?: any): AxiosPromise<void> {
            return DomainsApiFp(configuration).deleteDomain(domainName, options).then((request) => request(axios, basePath));
        },
        /**
         * To get details about a specific domain, send a GET request to `/v2/domains/$DOMAIN_NAME`.
         * @summary Retrieve an Existing Domain
         ...
         * @throws {RequiredError}
         */
        getDomain(domainName: string, options?: any): AxiosPromise<InlineResponse20019> {
            return DomainsApiFp(configuration).getDomain(domainName, options).then((request) => request(axios, basePath));
        },
        /**
         * To retrieve a list of all of the domains in your account, send a GET request to `/v2/domains`.
         * @summary List All Domains
         ...
         * @throws {RequiredError}
         */
        listAllDomains(options?: any): AxiosPromise<InlineResponse20018> {
            return DomainsApiFp(configuration).listAllDomains(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DomainsApi extends BaseAPI {
     ...
     * @memberof DomainsApi
     */
    public deleteDomain(domainName: string, options?: any) {
        return DomainsApiFp(this.configuration).deleteDomain(domainName, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To get details about a specific domain, send a GET request to `/v2/domains/$DOMAIN_NAME`.
     * @summary Retrieve an Existing Domain
     ...
     * @memberof DomainsApi
     */
    public getDomain(domainName: string, options?: any) {
        return DomainsApiFp(this.configuration).getDomain(domainName, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To retrieve a list of all of the domains in your account, send a GET request to `/v2/domains`.
     * @summary List All Domains
     ...
     * @memberof DomainsApi
     */
    public listAllDomains(options?: any) {
        return DomainsApiFp(this.configuration).listAllDomains(options).then((request) => request(this.axios, this.basePath));
    }
}
