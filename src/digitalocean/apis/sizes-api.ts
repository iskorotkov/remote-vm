...
export const SizesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        listAllSizes: async (perPage?: number, page?: number, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/sizes`;
...
export const SizesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listAllSizes(perPage?: number, page?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20052>> {
            const localVarAxiosArgs = await SizesApiAxiosParamCreator(configuration).listAllSizes(perPage, page, options);
...
export const SizesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAllSizes(perPage?: number, page?: number, options?: any): AxiosPromise<InlineResponse20052> {
            return SizesApiFp(configuration).listAllSizes(perPage, page, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SizesApi extends BaseAPI {
     ...
     * @memberof SizesApi
     */
    public listAllSizes(perPage?: number, page?: number, options?: any) {
        return SizesApiFp(this.configuration).listAllSizes(perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
}
