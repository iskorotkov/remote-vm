...
import { DropletIdActionsBody } from '../models';
import { DropletsActionsBody } from '../models';
import { InlineResponse2004 } from '../models';
import { InlineResponse2005 } from '../models';
import { InlineResponse20110 } from '../models';
/**
 * DropletActionsApi - axios parameter creator
 * @export
 */
export const DropletActionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getDropletAction: async (dropletId: number, actionId: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'dropletId' is not null or undefined
            if (dropletId === null || dropletId === undefined) {
                throw new RequiredError('dropletId','Required parameter dropletId was null or undefined when calling getDropletAction.');
            }
            // verify required parameter 'actionId' is not null or undefined
            if (actionId === null || actionId === undefined) {
                throw new RequiredError('actionId','Required parameter actionId was null or undefined when calling getDropletAction.');
            }
            const localVarPath = `/v2/droplets/{droplet_id}/actions/{action_id}`
         ...
         * @throws {RequiredError}
         */
        listDropletActions: async (dropletId: number, perPage?: number, page?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'dropletId' is not null or undefined
            if (dropletId === null || dropletId === undefined) {
                throw new RequiredError('dropletId','Required parameter dropletId was null or undefined when calling listDropletActions.');
            }
            const localVarPath = `/v2/droplets/{droplet_id}/actions`
                .replace(`{${"droplet_id"}}`, encodeURIComponent(String(dropletId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @param {number} dropletId A unique identifier for a Droplet instance.
         * @param {DropletIdActionsBody} [body] The &#x60;type&#x60; attribute set in the request body will specify the  action that
...
attributes to be set as well.
         ...
         * @throws {RequiredError}
         */
        postDropletAction: async (dropletId: number, body?: DropletIdActionsBody, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'dropletId' is not null or undefined
            if (dropletId === null || dropletId === undefined) {
                throw new RequiredError('dropletId','Required parameter dropletId was null or undefined when calling postDropletAction.');
            }
            const localVarPath = `/v2/droplets/{droplet_id}/actions`
                .replace(`{${"droplet_id"}}`, encodeURIComponent(String(dropletId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @param {DropletsActionsBody} [body] The &#x60;type&#x60; attribute set in the request body will specify the  action that
will be taken on the Droplet. Some actions will require additional
attributes to be set as well.
         ...
         * @throws {RequiredError}
         */
        postDropletActionByTag: async (body?: DropletsActionsBody, tagName?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/droplets/actions`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
/**
 * DropletActionsApi - functional programming interface
 * @export
 */
export const DropletActionsApiFp = function(configuration?: Configuration) {
    return {
        /**
         * To retrieve a Droplet action, send a GET request to `/v2/droplets/$DROPLET_ID/actions/$ACTION_ID`.  The response will be a JSON object with a key called `action`. The value will be a Droplet action object. 
         * @summary Retrieve a Droplet Action
         ...
         * @throws {RequiredError}
         */
        async getDropletAction(dropletId: number, actionId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>> {
            const localVarAxiosArgs = await DropletActionsApiAxiosParamCreator(configuration).getDropletAction(dropletId, actionId, options);
         ...
         * @throws {RequiredError}
         */
        async listDropletActions(dropletId: number, perPage?: number, page?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2004>> {
            const localVarAxiosArgs = await DropletActionsApiAxiosParamCreator(configuration).listDropletActions(dropletId, perPage, page, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
attributes to be set as well.
         ...
         * @throws {RequiredError}
         */
        async postDropletAction(dropletId: number, body?: DropletIdActionsBody, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>> {
            const localVarAxiosArgs = await DropletActionsApiAxiosParamCreator(configuration).postDropletAction(dropletId, body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
attributes to be set as well.
         ...
         * @throws {RequiredError}
         */
        async postDropletActionByTag(body?: DropletsActionsBody, tagName?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20110>> {
            const localVarAxiosArgs = await DropletActionsApiAxiosParamCreator(configuration).postDropletActionByTag(body, tagName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * DropletActionsApi - factory interface
 * @export
 */
export const DropletActionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * To retrieve a Droplet action, send a GET request to `/v2/droplets/$DROPLET_ID/actions/$ACTION_ID`.  The response will be a JSON object with a key called `action`. The value will be a Droplet action object. 
         * @summary Retrieve a Droplet Action
         ...
         * @throws {RequiredError}
         */
        getDropletAction(dropletId: number, actionId: number, options?: any): AxiosPromise<InlineResponse2005> {
            return DropletActionsApiFp(configuration).getDropletAction(dropletId, actionId, options).then((request) => request(axios, basePath));
        },
        /**
         * To retrieve a list of all actions that have been executed for a Droplet, send a GET request to `/v2/droplets/$DROPLET_ID/actions`.  The results will be returned as a JSON object with an `actions` key. This will be set to an array filled with `action` objects containing the standard `action` attributes. 
         * @summary List Actions for a Droplet
         ...
         * @throws {RequiredError}
         */
        listDropletActions(dropletId: number, perPage?: number, page?: number, options?: any): AxiosPromise<InlineResponse2004> {
            return DropletActionsApiFp(configuration).listDropletActions(dropletId, perPage, page, options).then((request) => request(axios, basePath));
        },
        /**
         * To initiate an action on a Droplet send a POST request to `/v2/droplets/$DROPLET_ID/actions`. In the JSON body to the request, set the `type` attribute to on of the supported action types:  | Action                                   | Details | | ---------------------------------------- | ----------- | | <nobr>`enable_backups`</nobr>            | Enables backups for a Droplet | | <nobr>`disable_backups`</nobr>           | Disables backups for a Droplet | | <nobr>`reboot`</nobr>                    | Reboots a Droplet. A `reboot` action is an attempt to reboot the Droplet in a graceful way, similar to using the `reboot` command from the console. | | <nobr>`power_cycle`</nobr>               | Power cycles a Droplet. A `powercycle` action is similar to pushing the reset button on a physical machine, it's similar to booting from scratch. | | <nobr>`shutdown`</nobr>                  | Shutsdown a Droplet. A shutdown action is an attempt to shutdown the Droplet in a graceful way, similar to using the `shutdown` command from the console. Since a `shutdown` command can fail, this action guarantees that the command is issued, not that it succeeds. The preferred way to turn off a Droplet is to attempt a shutdown, with a reasonable timeout, followed by a `power_off` action to ensure the Droplet is off. | | <nobr>`power_off`</nobr>                 | Powers off a Droplet. A `power_off` event is a hard shutdown and should only be used if the `shutdown` action is not successful. It is similar to cutting the power on a server and could lead to complications. | | <nobr>`power_on`</nobr>                  | Powers on a Droplet. | | <nobr>`restore`</nobr>                   | Restore a Droplet using a backup image. The image ID that is passed in must be a backup of the current Droplet instance. The operation will leave any embedded SSH keys intact. | | <nobr>`password_reset`</nobr>            | Resets the root password for a Droplet. A new password will be provided via email. It must be changed after first use. | | <nobr>`resize`</nobr>                    | Resizes a Droplet. Set the `size` attribute to a size slug. If a permanent resize with disk changes included is desired, set the `disk` attribute to `true`. | | <nobr>`rebuild`</nobr>                   | Rebuilds a Droplet from a new base image. Set the `image` attribute to an image ID or slug. | | <nobr>`rename`</nobr>                    | Renames a Droplet. | | <nobr>`change_kernel`</nobr>             | Changes a Droplet's kernel. Only applies to Droplets with externally managed kernels. All Droplets created after March 2017 use internal kernels by default. | | <nobr>`enable_ipv6`</nobr>               | Enables IPv6 for a Droplet. | | <nobr>`snapshot`</nobr>                  | Takes a snapshot of a Droplet. | 
         * @summary Initiate a Droplet Action
...
attributes to be set as well.
         ...
         * @throws {RequiredError}
         */
        postDropletAction(dropletId: number, body?: DropletIdActionsBody, options?: any): AxiosPromise<InlineResponse2005> {
            return DropletActionsApiFp(configuration).postDropletAction(dropletId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * Some actions can be performed in bulk on tagged Droplets. The actions can be initiated by sending a POST to `/v2/droplets/actions?tag_name=$TAG_NAME` with the action arguments.  Only a sub-set of action types are supported:  - `power_cycle` - `power_on` - `power_off` - `shutdown` - `enable_ipv6` - `enable_backups` - `disable_backups` - `snapshot` 
         * @summary Acting on Tagged Droplets
...
attributes to be set as well.
         ...
         * @throws {RequiredError}
         */
        postDropletActionByTag(body?: DropletsActionsBody, tagName?: string, options?: any): AxiosPromise<InlineResponse20110> {
            return DropletActionsApiFp(configuration).postDropletActionByTag(body, tagName, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * DropletActionsApi - object-oriented interface
 * @export
 * @class DropletActionsApi
 * @extends {BaseAPI}
 */
export class DropletActionsApi extends BaseAPI {
    /**
     * To retrieve a Droplet action, send a GET request to `/v2/droplets/$DROPLET_ID/actions/$ACTION_ID`.  The response will be a JSON object with a key called `action`. The value will be a Droplet action object. 
     * @summary Retrieve a Droplet Action
     * @param {number} dropletId A unique identifier for a Droplet instance.
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DropletActionsApi
     */
    public getDropletAction(dropletId: number, actionId: number, options?: any) {
        return DropletActionsApiFp(this.configuration).getDropletAction(dropletId, actionId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To retrieve a list of all actions that have been executed for a Droplet, send a GET request to `/v2/droplets/$DROPLET_ID/actions`.  The results will be returned as a JSON object with an `actions` key. This will be set to an array filled with `action` objects containing the standard `action` attributes. 
     * @summary List Actions for a Droplet
     ...
     * @memberof DropletActionsApi
     */
    public listDropletActions(dropletId: number, perPage?: number, page?: number, options?: any) {
        return DropletActionsApiFp(this.configuration).listDropletActions(dropletId, perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * To initiate an action on a Droplet send a POST request to `/v2/droplets/$DROPLET_ID/actions`. In the JSON body to the request, set the `type` attribute to on of the supported action types:  | Action                                   | Details | | ---------------------------------------- | ----------- | | <nobr>`enable_backups`</nobr>            | Enables backups for a Droplet | | <nobr>`disable_backups`</nobr>           | Disables backups for a Droplet | | <nobr>`reboot`</nobr>                    | Reboots a Droplet. A `reboot` action is an attempt to reboot the Droplet in a graceful way, similar to using the `reboot` command from the console. | | <nobr>`power_cycle`</nobr>               | Power cycles a Droplet. A `powercycle` action is similar to pushing the reset button on a physical machine, it's similar to booting from scratch. | | <nobr>`shutdown`</nobr>                  | Shutsdown a Droplet. A shutdown action is an attempt to shutdown the Droplet in a graceful way, similar to using the `shutdown` command from the console. Since a `shutdown` command can fail, this action guarantees that the command is issued, not that it succeeds. The preferred way to turn off a Droplet is to attempt a shutdown, with a reasonable timeout, followed by a `power_off` action to ensure the Droplet is off. | | <nobr>`power_off`</nobr>                 | Powers off a Droplet. A `power_off` event is a hard shutdown and should only be used if the `shutdown` action is not successful. It is similar to cutting the power on a server and could lead to complications. | | <nobr>`power_on`</nobr>                  | Powers on a Droplet. | | <nobr>`restore`</nobr>                   | Restore a Droplet using a backup image. The image ID that is passed in must be a backup of the current Droplet instance. The operation will leave any embedded SSH keys intact. | | <nobr>`password_reset`</nobr>            | Resets the root password for a Droplet. A new password will be provided via email. It must be changed after first use. | | <nobr>`resize`</nobr>                    | Resizes a Droplet. Set the `size` attribute to a size slug. If a permanent resize with disk changes included is desired, set the `disk` attribute to `true`. | | <nobr>`rebuild`</nobr>                   | Rebuilds a Droplet from a new base image. Set the `image` attribute to an image ID or slug. | | <nobr>`rename`</nobr>                    | Renames a Droplet. | | <nobr>`change_kernel`</nobr>             | Changes a Droplet's kernel. Only applies to Droplets with externally managed kernels. All Droplets created after March 2017 use internal kernels by default. | | <nobr>`enable_ipv6`</nobr>               | Enables IPv6 for a Droplet. | | <nobr>`snapshot`</nobr>                  | Takes a snapshot of a Droplet. | 
     * @summary Initiate a Droplet Action
...
attributes to be set as well.
     ...
     * @memberof DropletActionsApi
     */
    public postDropletAction(dropletId: number, body?: DropletIdActionsBody, options?: any) {
        return DropletActionsApiFp(this.configuration).postDropletAction(dropletId, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Some actions can be performed in bulk on tagged Droplets. The actions can be initiated by sending a POST to `/v2/droplets/actions?tag_name=$TAG_NAME` with the action arguments.  Only a sub-set of action types are supported:  - `power_cycle` - `power_on` - `power_off` - `shutdown` - `enable_ipv6` - `enable_backups` - `disable_backups` - `snapshot` 
     * @summary Acting on Tagged Droplets
...
attributes to be set as well.
     ...
     * @memberof DropletActionsApi
     */
    public postDropletActionByTag(body?: DropletsActionsBody, tagName?: string, options?: any) {
        return DropletActionsApiFp(this.configuration).postDropletActionByTag(body, tagName, options).then((request) => request(this.axios, this.basePath));
    }
}
