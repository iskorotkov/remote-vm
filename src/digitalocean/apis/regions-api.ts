...
export const RegionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        listAllRegions: async (perPage?: number, page?: number, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/regions`;
...
export const RegionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listAllRegions(perPage?: number, page?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20045>> {
            const localVarAxiosArgs = await RegionsApiAxiosParamCreator(configuration).listAllRegions(perPage, page, options);
...
export const RegionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAllRegions(perPage?: number, page?: number, options?: any): AxiosPromise<InlineResponse20045> {
            return RegionsApiFp(configuration).listAllRegions(perPage, page, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RegionsApi extends BaseAPI {
     ...
     * @memberof RegionsApi
     */
    public listAllRegions(perPage?: number, page?: number, options?: any) {
        return RegionsApiFp(this.configuration).listAllRegions(perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
}
