...
export const ActionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAction: async (actionId: number, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v2/actions/{action_id}`
         ...
         * @throws {RequiredError}
         */
        listAllActions: async (perPage?: number, page?: number, options: any = {}): Promise<RequestArgs> => {
...
export const ActionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAction(actionId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2005>> {
         ...
         * @throws {RequiredError}
         */
        async listAllActions(perPage?: number, page?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2004>> {
            const localVarAxiosArgs = await ActionsApiAxiosParamCreator(configuration).listAllActions(perPage, page, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ActionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAction(actionId: number, options?: any): AxiosPromise<InlineResponse2005> {
         ...
         * @throws {RequiredError}
         */
        listAllActions(perPage?: number, page?: number, options?: any): AxiosPromise<InlineResponse2004> {
            return ActionsApiFp(configuration).listAllActions(perPage, page, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ActionsApi extends BaseAPI {
     ...
     * @memberof ActionsApi
     */
    public getAction(actionId: number, options?: any) {
     ...
     * @memberof ActionsApi
     */
    public listAllActions(perPage?: number, page?: number, options?: any) {
        return ActionsApiFp(this.configuration).listAllActions(perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
}
