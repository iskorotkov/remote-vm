...
export interface DatabaseCluster {
    ...
    /**
     * 
     * @type {DatabaseConnection &amp; ModelObject}
     * @memberof DatabaseCluster
     */
    connection?: any;
    /**
    ...
    /**
     * 
     * @type {DatabaseMaintenanceWindow &amp; ModelObject}
     * @memberof DatabaseCluster
     */
...
/**
    ...
    * @enum {string}
    */
export enum DatabaseClusterEngineEnum {
    Pg = 'pg',
    Mysql = 'mysql',
    Redis = 'redis',
    Mongodb = 'mongodb'
...
/**
    ...
    * @enum {string}
    */
export enum DatabaseClusterStatusEnum {
    Creating = 'creating',
    Online = 'online',
    Resizing = 'resizing',
    Migrating = 'migrating',
