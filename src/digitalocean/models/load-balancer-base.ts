...
/**
    ...
    * @enum {string}
    */
export enum LoadBalancerBaseSizeEnum {
    Small = 'lb-small',
    Medium = 'lb-medium',
    Large = 'lb-large'
}
/**
    ...
    * @enum {string}
    */
export enum LoadBalancerBaseAlgorithmEnum {
...
/**
    ...
    * @enum {string}
    */
export enum LoadBalancerBaseStatusEnum {
    New = 'new',
    Active = 'active',
    Errored = 'errored'
}
