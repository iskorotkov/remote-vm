 ...
 * 
 * @export
 * @interface AlertPolicyRequest
 */
export interface AlertPolicyRequest {
    /**
     * 
     * @type {Alerts}
     * @memberof AlertPolicyRequest
     */
    alerts: any;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum AlertPolicyRequestCompareEnum {
...
/**
    ...
    * @enum {string}
    */
export enum AlertPolicyRequestTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export enum AlertPolicyRequestWindowEnum {
    _5m = '5m',
    _10m = '10m',
    _30m = '30m',
    _1h = '1h'
