...
export class BlockStorageActionsApi {
    ...
    */
     ...
     */
    getVolumeAction(volumeId, actionId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling getVolumeAction");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling getVolumeAction");
      }

      let pathParams = {
        'volume_id': volumeId,'action_id': actionId
      };
      let queryParams = {
      ...
      let returnType = InlineResponse2027;
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    listAllVolumeActions(volumeId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling listAllVolumeActions");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    postVolumeActionById(body, volumeId, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling postVolumeActionById");
      }
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling postVolumeActionById");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    postVolumeActionByName(body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling postVolumeActionByName");
      }
