...
export class ProjectsApi {
    ...
    */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    patchDefaultProject(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling patchDefaultProject");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    patchProject(body, projectId, callback) {
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    updateDefaultProject(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updateDefaultProject");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    updateProject(body, projectId, callback) {
