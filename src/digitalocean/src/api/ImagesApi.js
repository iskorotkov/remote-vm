...
export class ImagesApi {
    ...
    */
     ...
     */
    createCustomImage(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createCustomImage");
      }
    ...
    getImagesList(opts, callback) {
      ...
      let queryParams = {
        'type': opts['type'],'private': opts['_private'],'tag_name': opts['tagName'],'per_page': opts['perPage'],'page': opts['page']
      };
      let headerParams = {
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    updateImage(body, imageId, callback) {
