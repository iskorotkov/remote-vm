...
export class FloatingIPsApi {
    ...
    */
     ...
     */
    createFloatingIp(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createFloatingIp");
      }
     ...
     */
    deleteFloatingIp(floatingIp, callback) {
      
      let postBody = null;
      // verify the required parameter 'floatingIp' is set
      if (floatingIp === undefined || floatingIp === null) {
        throw new Error("Missing the required parameter 'floatingIp' when calling deleteFloatingIp");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    getFloatingIp(floatingIp, callback) {
      
      let postBody = null;
      // verify the required parameter 'floatingIp' is set
      if (floatingIp === undefined || floatingIp === null) {
        throw new Error("Missing the required parameter 'floatingIp' when calling getFloatingIp");
      }
