...
export class CertificatesApi {
    ...
    */
     ...
     */
    createCertificates(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createCertificates");
      }
    ...
    getCertificate(certificateId, callback) {
      ...
      // verify the required parameter 'certificateId' is set
      if (certificateId === undefined || certificateId === null) {
        throw new Error("Missing the required parameter 'certificateId' when calling getCertificate");
      }
