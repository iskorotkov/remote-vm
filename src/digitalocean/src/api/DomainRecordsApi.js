...
export class DomainRecordsApi {
    ...
    */
     ...
     */
    createDomainRecord(domainName, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling createDomainRecord");
      }
     ...
     */
    deleteDomainRecord(domainName, domainRecordId, callback) {
      
      let postBody = null;
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling deleteDomainRecord");
      }
      // verify the required parameter 'domainRecordId' is set
      if (domainRecordId === undefined || domainRecordId === null) {
        throw new Error("Missing the required parameter 'domainRecordId' when calling deleteDomainRecord");
      }

      let pathParams = {
        'domain_name': domainName,'domain_record_id': domainRecordId
      };
      let queryParams = {
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    getDomainRecord(domainName, domainRecordId, callback) {
      
      let postBody = null;
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling getDomainRecord");
      }
      // verify the required parameter 'domainRecordId' is set
      if (domainRecordId === undefined || domainRecordId === null) {
        throw new Error("Missing the required parameter 'domainRecordId' when calling getDomainRecord");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    listAllDomainRecords(domainName, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling listAllDomainRecords");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    patchUpdateDomainRecord(domainName, domainRecordId, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling patchUpdateDomainRecord");
      }
      // verify the required parameter 'domainRecordId' is set
      if (domainRecordId === undefined || domainRecordId === null) {
        throw new Error("Missing the required parameter 'domainRecordId' when calling patchUpdateDomainRecord");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    updateDomainRecord(domainName, domainRecordId, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling updateDomainRecord");
      }
      // verify the required parameter 'domainRecordId' is set
      if (domainRecordId === undefined || domainRecordId === null) {
        throw new Error("Missing the required parameter 'domainRecordId' when calling updateDomainRecord");
      }
