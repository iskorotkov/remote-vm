...
export class FloatingIPActionsApi {
    ...
    */
     ...
     */
    getFloatingIpAction(floatingIp, actionId, callback) {
      
      let postBody = null;
      // verify the required parameter 'floatingIp' is set
      if (floatingIp === undefined || floatingIp === null) {
        throw new Error("Missing the required parameter 'floatingIp' when calling getFloatingIpAction");
      }
      // verify the required parameter 'actionId' is set
      if (actionId === undefined || actionId === null) {
        throw new Error("Missing the required parameter 'actionId' when calling getFloatingIpAction");
      }

      let pathParams = {
        'floating_ip': floatingIp,'action_id': actionId
      };
      let queryParams = {
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    listFloatingIpActions(floatingIp, callback) {
      
      let postBody = null;
      // verify the required parameter 'floatingIp' is set
      if (floatingIp === undefined || floatingIp === null) {
        throw new Error("Missing the required parameter 'floatingIp' when calling listFloatingIpActions");
      }
...
will be taken on the floating IP.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    postFloatingIpAction(floatingIp, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'floatingIp' is set
      if (floatingIp === undefined || floatingIp === null) {
        throw new Error("Missing the required parameter 'floatingIp' when calling postFloatingIpAction");
      }
