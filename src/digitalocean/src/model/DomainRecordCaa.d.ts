/**
 * The DomainRecordCaa model module.
 * @module model/DomainRecordCaa
 * @version 2.0
 */
export class DomainRecordCaa extends DomainRecord {
    /**
     * Constructs a new <code>DomainRecordCaa</code>.
     * @alias module:model/DomainRecordCaa
     * @class
