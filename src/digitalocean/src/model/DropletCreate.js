...
/**
 * The DropletCreate model module.
 * @module model/DropletCreate
 * @version 2.0
 */
export class DropletCreate {
  /**
   * Constructs a new <code>DropletCreate</code>.
   * @alias module:model/DropletCreate
   * @class
   * @param region {String} The slug identifier for the region that you wish to deploy the Droplet in.
   * @param size {String} The slug identifier for the size that you wish to select for this Droplet.
   * @param image {Object} The image ID of a public or private image or the slug identifier for a public image. This image will be the base image for your Droplet.
   */
  constructor(region, size, image) {
    this.region = region;
    this.size = size;
    this.image = image;
  }
  ...
  /**
   * Constructs a <code>DropletCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DropletCreate} obj Optional instance to populate.
   * @return {module:model/DropletCreate} The populated <code>DropletCreate</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DropletCreate();
      ...
      if (data.hasOwnProperty('ssh_keys'))
        obj.sshKeys = ApiClient.convertToType(data['ssh_keys'], [AnyOfdropletCreateSshKeysItems]);
      if (data.hasOwnProperty('backups'))
        obj.backups = ApiClient.convertToType(data['backups'], 'Boolean');
      if (data.hasOwnProperty('ipv6'))
        obj.ipv6 = ApiClient.convertToType(data['ipv6'], 'Boolean');
      ...
      if (data.hasOwnProperty('user_data'))
        obj.userData = ApiClient.convertToType(data['user_data'], 'String');
      if (data.hasOwnProperty('private_networking'))
        obj.privateNetworking = ApiClient.convertToType(data['private_networking'], 'Boolean');
      if (data.hasOwnProperty('vpc_uuid'))
        obj.vpcUuid = ApiClient.convertToType(data['vpc_uuid'], 'String');
      if (data.hasOwnProperty('with_droplet_agent'))
        obj.withDropletAgent = ApiClient.convertToType(data['with_droplet_agent'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
DropletCreate.prototype.region = undefined;

/**
 * The slug identifier for the size that you wish to select for this Droplet.
 * @member {String} size
 */
DropletCreate.prototype.size = undefined;
 ...
 * @member {Object} image
 */
DropletCreate.prototype.image = undefined;
 ...
 */
DropletCreate.prototype.sshKeys = undefined;
 ...
 * @default false
 */
DropletCreate.prototype.backups = false;
 ...
 * @default false
 */
DropletCreate.prototype.ipv6 = false;
 ...
 * @default false
 */
DropletCreate.prototype.monitoring = false;
 ...
 */
DropletCreate.prototype.tags = undefined;
 ...
 */
DropletCreate.prototype.userData = undefined;
 ...
 * @default false
 */
DropletCreate.prototype.privateNetworking = false;
 ...
 */
DropletCreate.prototype.vpcUuid = undefined;
 ...
 */
DropletCreate.prototype.withDropletAgent = undefined;
