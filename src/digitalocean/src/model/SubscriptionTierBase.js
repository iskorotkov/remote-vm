...
export class SubscriptionTierBase {
  /**
   * Constructs a new <code>SubscriptionTierBase</code>.
   * @alias module:model/SubscriptionTierBase
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SubscriptionTierBase();
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('slug'))
        obj.slug = ApiClient.convertToType(data['slug'], 'String');
      if (data.hasOwnProperty('included_repositories'))
        obj.includedRepositories = ApiClient.convertToType(data['included_repositories'], 'Number');
      if (data.hasOwnProperty('included_storage_bytes'))
        obj.includedStorageBytes = ApiClient.convertToType(data['included_storage_bytes'], 'Number');
      if (data.hasOwnProperty('allow_storage_overage'))
        obj.allowStorageOverage = ApiClient.convertToType(data['allow_storage_overage'], 'Boolean');
      if (data.hasOwnProperty('included_bandwidth_bytes'))
        obj.includedBandwidthBytes = ApiClient.convertToType(data['included_bandwidth_bytes'], 'Number');
      if (data.hasOwnProperty('monthly_price_in_cents'))
        obj.monthlyPriceInCents = ApiClient.convertToType(data['monthly_price_in_cents'], 'Number');
    }
    return obj;
  }
}
 ...
 * @member {String} name
 */
SubscriptionTierBase.prototype.name = undefined;

/**
 * The slug identifier of the subscription tier.
 * @member {String} slug
 */
SubscriptionTierBase.prototype.slug = undefined;
 ...
 */
SubscriptionTierBase.prototype.includedRepositories = undefined;

/**
 * The amount of storage included in the subscription tier in bytes.
 * @member {Number} includedStorageBytes
 */
SubscriptionTierBase.prototype.includedStorageBytes = undefined;
