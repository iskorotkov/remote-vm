...
import {AppComponentInstanceBase} from './AppComponentInstanceBase';
import {AppRouteSpec} from './AppRouteSpec';
import {AppServiceSpecHealthCheck} from './AppServiceSpecHealthCheck';
import {AppVariableDefinition} from './AppVariableDefinition';
import {AppsCorsPolicy} from './AppsCorsPolicy';
import {AppsGitSourceSpec} from './AppsGitSourceSpec';
import {AppsGithubSourceSpec} from './AppsGithubSourceSpec';
import {AppsGitlabSourceSpec} from './AppsGitlabSourceSpec';
import {AppsImageSourceSpec} from './AppsImageSourceSpec';
...
export class AppServiceSpec extends AppComponentBase {
  ...
  /**
   * Constructs a <code>AppServiceSpec</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppServiceSpec} obj Optional instance to populate.
   * @return {module:model/AppServiceSpec} The populated <code>AppServiceSpec</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppServiceSpec();
      AppComponentBase.constructFromObject(data, obj);
      if (data.hasOwnProperty('instance_count'))
        obj.instanceCount = ApiClient.convertToType(data['instance_count'], 'Number');
      if (data.hasOwnProperty('instance_size_slug'))
        obj.instanceSizeSlug = ApiClient.convertToType(data['instance_size_slug'], 'String');
      if (data.hasOwnProperty('cors'))
        obj.cors = AppsCorsPolicy.constructFromObject(data['cors']);
      if (data.hasOwnProperty('health_check'))
        obj.healthCheck = AppServiceSpecHealthCheck.constructFromObject(data['health_check']);
      if (data.hasOwnProperty('http_port'))
        obj.httpPort = ApiClient.convertToType(data['http_port'], 'Number');
      if (data.hasOwnProperty('internal_ports'))
        obj.internalPorts = ApiClient.convertToType(data['internal_ports'], ['Number']);
      if (data.hasOwnProperty('routes'))
        obj.routes = ApiClient.convertToType(data['routes'], [AppRouteSpec]);
    }
    return obj;
  }
}
 ...
 * @default 1
 */
AppServiceSpec.prototype.instanceCount = 1;

/**
 * Allowed values for the <code>instanceSizeSlug</code> property.
 * @enum {String}
 * @readonly
 */
AppServiceSpec.InstanceSizeSlugEnum = {
  /**
   * value: "basic-xxs"
   * @const
   */
 ...
 * @default 'basic-xxs'
 */
AppServiceSpec.prototype.instanceSizeSlug = 'basic-xxs';

/**
 * @member {module:model/AppsCorsPolicy} cors
 */
AppServiceSpec.prototype.cors = undefined;

/**
 * @member {module:model/AppServiceSpecHealthCheck} healthCheck
 */
AppServiceSpec.prototype.healthCheck = undefined;
