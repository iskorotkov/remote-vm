...
export class AppWorkerSpec extends AppComponentBase {
  ...
  /**
   * Constructs a <code>AppWorkerSpec</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppWorkerSpec} obj Optional instance to populate.
   * @return {module:model/AppWorkerSpec} The populated <code>AppWorkerSpec</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppWorkerSpec();
 ...
 * @default 1
 */
AppWorkerSpec.prototype.instanceCount = 1;
 ...
 * @readonly
 */
AppWorkerSpec.InstanceSizeSlugEnum = {
  /**
   * value: "basic-xxs"
   * @const
   */
 ...
 * @default 'basic-xxs'
 */
AppWorkerSpec.prototype.instanceSizeSlug = 'basic-xxs';
