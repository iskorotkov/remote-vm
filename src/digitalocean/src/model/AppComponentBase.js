...
export class AppComponentBase {
  /**
   * Constructs a new <code>AppComponentBase</code>.
   * @alias module:model/AppComponentBase
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppComponentBase();
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('git'))
        obj.git = AppsGitSourceSpec.constructFromObject(data['git']);
      if (data.hasOwnProperty('github'))
        obj.github = AppsGithubSourceSpec.constructFromObject(data['github']);
      if (data.hasOwnProperty('gitlab'))
        obj.gitlab = AppsGitlabSourceSpec.constructFromObject(data['gitlab']);
      if (data.hasOwnProperty('image'))
        obj.image = AppsImageSourceSpec.constructFromObject(data['image']);
      if (data.hasOwnProperty('dockerfile_path'))
        obj.dockerfilePath = ApiClient.convertToType(data['dockerfile_path'], 'String');
      if (data.hasOwnProperty('build_command'))
        obj.buildCommand = ApiClient.convertToType(data['build_command'], 'String');
      if (data.hasOwnProperty('run_command'))
        obj.runCommand = ApiClient.convertToType(data['run_command'], 'String');
      if (data.hasOwnProperty('source_dir'))
        obj.sourceDir = ApiClient.convertToType(data['source_dir'], 'String');
      if (data.hasOwnProperty('envs'))
        obj.envs = ApiClient.convertToType(data['envs'], [AppVariableDefinition]);
      if (data.hasOwnProperty('environment_slug'))
        obj.environmentSlug = ApiClient.convertToType(data['environment_slug'], 'String');
    }
    return obj;
  }
}
 ...
 * @member {String} name
 */
AppComponentBase.prototype.name = undefined;

/**
 * @member {module:model/AppsGitSourceSpec} git
 */
AppComponentBase.prototype.git = undefined;

/**
 * @member {module:model/AppsGithubSourceSpec} github
 */
AppComponentBase.prototype.github = undefined;

/**
 * @member {module:model/AppsGitlabSourceSpec} gitlab
 */
AppComponentBase.prototype.gitlab = undefined;

/**
 * @member {module:model/AppsImageSourceSpec} image
 */
AppComponentBase.prototype.image = undefined;

/**
 * The path to the Dockerfile relative to the root of the repo. If set, it will be used to build this component. Otherwise, App Platform will attempt to build it using buildpacks.
 * @member {String} dockerfilePath
 */
AppComponentBase.prototype.dockerfilePath = undefined;

/**
 * An optional build command to run while building this component from source.
 * @member {String} buildCommand
 */
AppComponentBase.prototype.buildCommand = undefined;

/**
 * An optional run command to override the component's default.
 * @member {String} runCommand
 */
AppComponentBase.prototype.runCommand = undefined;

/**
 * An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
 * @member {String} sourceDir
 */
AppComponentBase.prototype.sourceDir = undefined;

/**
 * A list of environment variables made available to the component.
 * @member {Array.<module:model/AppVariableDefinition>} envs
 */
AppComponentBase.prototype.envs = undefined;
 ...
 */
AppComponentBase.prototype.environmentSlug = undefined;
