...
export class Cluster {
   ...
   */
  constructor(name, region, version, nodePools) {
    this.name = name;
    this.region = region;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cluster_subnet'))
        obj.clusterSubnet = ApiClient.convertToType(data['cluster_subnet'], 'String');
      if (data.hasOwnProperty('service_subnet'))
        obj.serviceSubnet = ApiClient.convertToType(data['service_subnet'], 'String');
      ...
      if (data.hasOwnProperty('node_pools'))
        obj.nodePools = ApiClient.convertToType(data['node_pools'], [KubernetesNodePool]);
      if (data.hasOwnProperty('maintenance_policy'))
        obj.maintenancePolicy = MaintenancePolicy.constructFromObject(data['maintenance_policy']);
      if (data.hasOwnProperty('auto_upgrade'))
        obj.autoUpgrade = ApiClient.convertToType(data['auto_upgrade'], 'Boolean');
      ...
      if (data.hasOwnProperty('surge_upgrade'))
        obj.surgeUpgrade = ApiClient.convertToType(data['surge_upgrade'], 'Boolean');
      if (data.hasOwnProperty('registry_enabled'))
        obj.registryEnabled = ApiClient.convertToType(data['registry_enabled'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
Cluster.prototype.clusterSubnet = undefined;
 ...
 * @default false
 */
Cluster.prototype.autoUpgrade = false;
 ...
 */
Cluster.prototype.updatedAt = undefined;
 ...
 * @default false
 */
Cluster.prototype.surgeUpgrade = false;
 ...
 */
Cluster.prototype.registryEnabled = undefined;
