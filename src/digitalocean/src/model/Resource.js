...
export class Resource {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('assigned_at'))
        obj.assignedAt = ApiClient.convertToType(data['assigned_at'], 'Date');
 ...
 */
Resource.prototype.urn = undefined;
 ...
 */
Resource.prototype.assignedAt = undefined;
