...
export class Size {
   ...
   */
  constructor(slug, memory, vcpus, disk, transfer, priceMonthly, priceHourly, regions, available, description) {
    this.slug = slug;
    this.memory = memory;
    this.vcpus = vcpus;
    this.disk = disk;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('price_monthly'))
        obj.priceMonthly = ApiClient.convertToType(data['price_monthly'], 'Number');
      if (data.hasOwnProperty('price_hourly'))
        obj.priceHourly = ApiClient.convertToType(data['price_hourly'], 'Number');
 ...
 */
Size.prototype.description = undefined;
