...
import {DropletNetworks} from './DropletNetworks';
import {DropletNextBackupWindow} from './DropletNextBackupWindow';
...
export class Droplet {
   ...
   */
  constructor(id, name, memory, vcpus, disk, locked, status, kernel, createdAt, features, backupIds, nextBackupWindow, snapshotIds, image, volumeIds, size, sizeSlug, networks, region, tags) {
    this.id = id;
    this.name = name;
    this.memory = memory;
    this.vcpus = vcpus;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('kernel'))
        obj.kernel = Kernel.constructFromObject(data['kernel']);
      if (data.hasOwnProperty('created_at'))
        obj.createdAt = ApiClient.convertToType(data['created_at'], 'Date');
      if (data.hasOwnProperty('features'))
        obj.features = ApiClient.convertToType(data['features'], ['String']);
      if (data.hasOwnProperty('backup_ids'))
        obj.backupIds = ApiClient.convertToType(data['backup_ids'], ['Number']);
      if (data.hasOwnProperty('next_backup_window'))
        obj.nextBackupWindow = DropletNextBackupWindow.constructFromObject(data['next_backup_window']);
      if (data.hasOwnProperty('snapshot_ids'))
        obj.snapshotIds = ApiClient.convertToType(data['snapshot_ids'], ['Number']);
      if (data.hasOwnProperty('image'))
        obj.image = Image.constructFromObject(data['image']);
      if (data.hasOwnProperty('volume_ids'))
        obj.volumeIds = ApiClient.convertToType(data['volume_ids'], ['String']);
      if (data.hasOwnProperty('size'))
        obj.size = Size.constructFromObject(data['size']);
      if (data.hasOwnProperty('size_slug'))
        obj.sizeSlug = ApiClient.convertToType(data['size_slug'], 'String');
      if (data.hasOwnProperty('networks'))
        obj.networks = DropletNetworks.constructFromObject(data['networks']);
      if (data.hasOwnProperty('region'))
        obj.region = Region.constructFromObject(data['region']);
      if (data.hasOwnProperty('tags'))
        obj.tags = ApiClient.convertToType(data['tags'], ['String']);
      if (data.hasOwnProperty('vpc_uuid'))
        obj.vpcUuid = ApiClient.convertToType(data['vpc_uuid'], 'String');
    }
    return obj;
  }
}
 ...
 * @member {module:model/Droplet.StatusEnum} status
 */
Droplet.prototype.status = undefined;

/**
 * @member {module:model/Kernel} kernel
 */
Droplet.prototype.kernel = undefined;

/**
 * A time value given in ISO8601 combined date and time format that represents when the Droplet was created.
 * @member {Date} createdAt
 */
Droplet.prototype.createdAt = undefined;

/**
 * An array of features enabled on this Droplet.
 * @member {Array.<String>} features
 */
Droplet.prototype.features = undefined;
 ...
 * @member {Array.<Number>} backupIds
 */
Droplet.prototype.backupIds = undefined;

/**
 * @member {module:model/DropletNextBackupWindow} nextBackupWindow
 */
Droplet.prototype.nextBackupWindow = undefined;

/**
 * An array of snapshot IDs of any snapshots created from the Droplet instance.
 * @member {Array.<Number>} snapshotIds
 */
Droplet.prototype.snapshotIds = undefined;

/**
 * @member {module:model/Image} image
 */
Droplet.prototype.image = undefined;
 ...
 */
Droplet.prototype.volumeIds = undefined;

/**
 * @member {module:model/Size} size
 */
Droplet.prototype.size = undefined;

/**
 * The unique slug identifier for the size of this Droplet.
 * @member {String} sizeSlug
 */
Droplet.prototype.sizeSlug = undefined;

/**
 * @member {module:model/DropletNetworks} networks
 */
Droplet.prototype.networks = undefined;

/**
 * @member {module:model/Region} region
 */
Droplet.prototype.region = undefined;

/**
 * An array of Tags the Droplet has been tagged with.
 * @member {Array.<String>} tags
 */
Droplet.prototype.tags = undefined;

/**
 * A string specifying the UUID of the VPC to which the Droplet is assigned.
 * @member {String} vpcUuid
 */
Droplet.prototype.vpcUuid = undefined;

// Implement AnyOffloatingIpDroplet interface:
