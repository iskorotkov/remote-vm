...
export class InvoiceSummary {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoice_uuid'))
        obj.invoiceUuid = ApiClient.convertToType(data['invoice_uuid'], 'String');
      if (data.hasOwnProperty('billing_period'))
        obj.billingPeriod = ApiClient.convertToType(data['billing_period'], 'String');
      if (data.hasOwnProperty('amount'))
        obj.amount = ApiClient.convertToType(data['amount'], 'String');
      if (data.hasOwnProperty('user_name'))
        obj.userName = ApiClient.convertToType(data['user_name'], 'String');
      if (data.hasOwnProperty('user_billing_address'))
        obj.userBillingAddress = ApiClient.convertToType(data['user_billing_address'], Object);
      if (data.hasOwnProperty('user_company'))
        obj.userCompany = ApiClient.convertToType(data['user_company'], 'String');
      if (data.hasOwnProperty('user_email'))
        obj.userEmail = ApiClient.convertToType(data['user_email'], 'String');
      if (data.hasOwnProperty('product_charges'))
        obj.productCharges = ApiClient.convertToType(data['product_charges'], Object);
      if (data.hasOwnProperty('overages'))
        obj.overages = ApiClient.convertToType(data['overages'], Object);
      if (data.hasOwnProperty('taxes'))
        obj.taxes = ApiClient.convertToType(data['taxes'], Object);
      if (data.hasOwnProperty('credits_and_adjustments'))
        obj.creditsAndAdjustments = ApiClient.convertToType(data['credits_and_adjustments'], Object);
    }
    return obj;
  }
}
