...
const RegionSlug = {
  ...
  /**
   * Returns a <code>RegionSlug</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/RegionSlug} The enum <code>RegionSlug</code> value.
   */
