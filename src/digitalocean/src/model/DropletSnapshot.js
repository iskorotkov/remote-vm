...
export class DropletSnapshot {
   ...
   */
  constructor(name, createdAt, regions, minDiskSize, sizeGigabytes, type) {
    this.name = name;
 ...
 */
DropletSnapshot.prototype.regions = undefined;

/**
 * The minimum size in GB required for a volume or Droplet to use this snapshot.
 * @member {Number} minDiskSize
 */
DropletSnapshot.prototype.minDiskSize = undefined;

/**
 * The billable size of the snapshot in gigabytes.
 * @member {Number} sizeGigabytes
 */
DropletSnapshot.prototype.sizeGigabytes = undefined;
 ...
 * @member {module:model/DropletSnapshot.TypeEnum} type
 */
DropletSnapshot.prototype.type = undefined;
