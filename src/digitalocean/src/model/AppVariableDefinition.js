...
export class AppVariableDefinition {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppVariableDefinition();
 ...
 * @member {String} key
 */
AppVariableDefinition.prototype.key = undefined;
 ...
 * @readonly
 */
AppVariableDefinition.ScopeEnum = {
  /**
   * value: "UNSET"
   * @const
   */
 ...
 */
AppVariableDefinition.prototype.scope = 'RUN_AND_BUILD_TIME';
 ...
 * @readonly
 */
AppVariableDefinition.TypeEnum = {
  /**
   * value: "GENERAL"
   * @const
   */
 ...
 * @default 'GENERAL'
 */
AppVariableDefinition.prototype.type = 'GENERAL';
 ...
 * @member {String} value
 */
AppVariableDefinition.prototype.value = undefined;
