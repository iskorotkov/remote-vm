...
import {AppDatabaseSpec} from './AppDatabaseSpec';
import {AppDomainSpec} from './AppDomainSpec';
import {AppJobSpec} from './AppJobSpec';
import {AppServiceSpec} from './AppServiceSpec';
import {AppStaticSiteSpec} from './AppStaticSiteSpec';
import {AppWorkerSpec} from './AppWorkerSpec';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('domains'))
        obj.domains = ApiClient.convertToType(data['domains'], [AppDomainSpec]);
      if (data.hasOwnProperty('services'))
        obj.services = ApiClient.convertToType(data['services'], [AppServiceSpec]);
      if (data.hasOwnProperty('static_sites'))
        obj.staticSites = ApiClient.convertToType(data['static_sites'], [AppStaticSiteSpec]);
      if (data.hasOwnProperty('jobs'))
        obj.jobs = ApiClient.convertToType(data['jobs'], [AppJobSpec]);
      if (data.hasOwnProperty('workers'))
        obj.workers = ApiClient.convertToType(data['workers'], [AppWorkerSpec]);
      if (data.hasOwnProperty('databases'))
        obj.databases = ApiClient.convertToType(data['databases'], [AppDatabaseSpec]);
    }
    return obj;
  }
}
 ...
 * @member {String} name
 */
AppSpec.prototype.name = undefined;
 ...
 */
AppSpec.prototype.databases = undefined;
