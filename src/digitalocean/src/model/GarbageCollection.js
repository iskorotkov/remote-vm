...
export class GarbageCollection {
  /**
   * Constructs a new <code>GarbageCollection</code>.
   * @alias module:model/GarbageCollection
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('blobs_deleted'))
        obj.blobsDeleted = ApiClient.convertToType(data['blobs_deleted'], 'Number');
      if (data.hasOwnProperty('freed_bytes'))
        obj.freedBytes = ApiClient.convertToType(data['freed_bytes'], 'Number');
    }
    return obj;
  }
}
 ...
 * @member {String} uuid
 */
GarbageCollection.prototype.uuid = undefined;

/**
 * The name of the container registry.
 * @member {String} registryName
 */
GarbageCollection.prototype.registryName = undefined;
