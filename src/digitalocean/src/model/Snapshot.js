...
export class Snapshot {
   ...
   */
  constructor(name, createdAt, regions, minDiskSize, sizeGigabytes, resourceId, resourceType, tags) {
    this.name = name;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('min_disk_size'))
        obj.minDiskSize = ApiClient.convertToType(data['min_disk_size'], 'Number');
      if (data.hasOwnProperty('size_gigabytes'))
        obj.sizeGigabytes = ApiClient.convertToType(data['size_gigabytes'], 'Number');
 ...
 */
Snapshot.prototype.createdAt = undefined;
 ...
 */
Snapshot.prototype.regions = undefined;

/**
 * The minimum size in GB required for a volume or Droplet to use this snapshot.
 * @member {Number} minDiskSize
 */
Snapshot.prototype.minDiskSize = undefined;

/**
 * The billable size of the snapshot in gigabytes.
 * @member {Number} sizeGigabytes
 */
Snapshot.prototype.sizeGigabytes = undefined;

/**
 * The unique identifier for the resource that the snapshot originated from.
 * @member {String} resourceId
 */
Snapshot.prototype.resourceId = undefined;
 ...
 * @member {module:model/Snapshot.ResourceTypeEnum} resourceType
 */
Snapshot.prototype.resourceType = undefined;
