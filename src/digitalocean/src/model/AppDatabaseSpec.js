...
export class AppDatabaseSpec {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppDatabaseSpec();
      if (data.hasOwnProperty('cluster_name'))
        obj.clusterName = ApiClient.convertToType(data['cluster_name'], 'String');
      if (data.hasOwnProperty('db_name'))
        obj.dbName = ApiClient.convertToType(data['db_name'], 'String');
      if (data.hasOwnProperty('db_user'))
        obj.dbUser = ApiClient.convertToType(data['db_user'], 'String');
 ...
 */
AppDatabaseSpec.prototype.clusterName = undefined;

/**
 * The name of the MySQL or PostgreSQL database to configure.
 * @member {String} dbName
 */
AppDatabaseSpec.prototype.dbName = undefined;

/**
 * The name of the MySQL or PostgreSQL user to configure.
 * @member {String} dbUser
 */
AppDatabaseSpec.prototype.dbUser = undefined;
 ...
 * @default 'UNSET'
 */
AppDatabaseSpec.prototype.engine = 'UNSET';

/**
 * The name. Must be unique across all components within the same app.
 * @member {String} name
 */
AppDatabaseSpec.prototype.name = undefined;

/**
 * Whether this is a production or dev database.
 * @member {Boolean} production
 */
AppDatabaseSpec.prototype.production = undefined;

/**
 * The version of the database engine
 * @member {String} version
 */
AppDatabaseSpec.prototype.version = undefined;
