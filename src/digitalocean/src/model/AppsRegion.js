...
export class AppsRegion {
  /**
   * Constructs a new <code>AppsRegion</code>.
   * @alias module:model/AppsRegion
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppsRegion();
      if (data.hasOwnProperty('continent'))
        obj.continent = ApiClient.convertToType(data['continent'], 'String');
      if (data.hasOwnProperty('data_centers'))
        obj.dataCenters = ApiClient.convertToType(data['data_centers'], ['String']);
 ...
 */
AppsRegion.prototype.continent = undefined;

/**
 * @member {Array.<String>} dataCenters
 */
AppsRegion.prototype.dataCenters = undefined;

/**
 * Whether or not the region is presented as the default.
 * @member {Boolean} _default
 */
AppsRegion.prototype._default = undefined;

/**
 * @member {Boolean} disabled
 */
AppsRegion.prototype.disabled = undefined;

/**
 * @member {String} flag
 */
AppsRegion.prototype.flag = undefined;

/**
 * @member {String} label
 */
AppsRegion.prototype.label = undefined;

/**
 * @member {String} reason
 */
AppsRegion.prototype.reason = undefined;

/**
 * @member {String} slug
 */
AppsRegion.prototype.slug = undefined;
