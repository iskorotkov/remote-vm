...
export class AllOfdatabaseReplicaPrivateConnection {
  /**
   * Constructs a new <code>AllOfdatabaseReplicaPrivateConnection</code>.
   * @alias module:model/AllOfdatabaseReplicaPrivateConnection
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfdatabaseReplicaPrivateConnection();
 ...
 * @member {String} uri
 */
AllOfdatabaseReplicaPrivateConnection.prototype.uri = undefined;

/**
 * The name of the default database.
 * @member {String} database
 */
AllOfdatabaseReplicaPrivateConnection.prototype.database = undefined;

/**
 * The FQDN pointing to the database cluster's current primary node.
 * @member {String} host
 */
AllOfdatabaseReplicaPrivateConnection.prototype.host = undefined;

/**
 * The port on which the database cluster is listening.
 * @member {Number} port
 */
AllOfdatabaseReplicaPrivateConnection.prototype.port = undefined;

/**
 * The default user for the database.
 * @member {String} user
 */
AllOfdatabaseReplicaPrivateConnection.prototype.user = undefined;

/**
 * The randomly generated password for the default user.
 * @member {String} password
 */
AllOfdatabaseReplicaPrivateConnection.prototype.password = undefined;

/**
 * A boolean value indicating if the connection should be made over SSL.
 * @member {Boolean} ssl
 */
AllOfdatabaseReplicaPrivateConnection.prototype.ssl = undefined;
