/**
 * The DomainRecordNs model module.
 * @module model/DomainRecordNs
 * @version 2.0
 */
export class DomainRecordNs extends DomainRecord {
    /**
     * Constructs a new <code>DomainRecordNs</code>.
     * @alias module:model/DomainRecordNs
     * @class
