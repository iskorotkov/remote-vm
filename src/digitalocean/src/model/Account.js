...
export class Account {
   ...
   */
  constructor(dropletLimit, floatingIpLimit, email, uuid, emailVerified, status, statusMessage) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new Account();
      if (data.hasOwnProperty('droplet_limit'))
        obj.dropletLimit = ApiClient.convertToType(data['droplet_limit'], 'Number');
      if (data.hasOwnProperty('floating_ip_limit'))
        obj.floatingIpLimit = ApiClient.convertToType(data['floating_ip_limit'], 'Number');
 ...
 * @member {Number} dropletLimit
 */
Account.prototype.dropletLimit = undefined;

/**
 * The total number of Floating IPs the current user or team may have.
 * @member {Number} floatingIpLimit
 */
Account.prototype.floatingIpLimit = undefined;
 ...
 * @default false
 */
Account.prototype.emailVerified = false;
