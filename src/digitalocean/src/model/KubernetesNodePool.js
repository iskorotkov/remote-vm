...
import {KubernetesNodePoolTaint} from './KubernetesNodePoolTaint';
...
export class KubernetesNodePool extends KubernetesNodePoolSize {
  ...
  /**
   * Constructs a <code>KubernetesNodePool</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KubernetesNodePool} obj Optional instance to populate.
   * @return {module:model/KubernetesNodePool} The populated <code>KubernetesNodePool</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new KubernetesNodePool();
      KubernetesNodePoolSize.constructFromObject(data, obj);
      ...
      if (data.hasOwnProperty('taints'))
        obj.taints = ApiClient.convertToType(data['taints'], [KubernetesNodePoolTaint]);
      if (data.hasOwnProperty('auto_scale'))
        obj.autoScale = ApiClient.convertToType(data['auto_scale'], 'Boolean');
      if (data.hasOwnProperty('min_nodes'))
        obj.minNodes = ApiClient.convertToType(data['min_nodes'], 'Number');
      if (data.hasOwnProperty('max_nodes'))
        obj.maxNodes = ApiClient.convertToType(data['max_nodes'], 'Number');
 ...
 * @member {String} id
 */
KubernetesNodePool.prototype.id = undefined;

/**
 * A human-readable name for the node pool.
 * @member {String} name
 */
KubernetesNodePool.prototype.name = undefined;

/**
 * The number of Droplet instances in the node pool.
 * @member {Number} count
 */
KubernetesNodePool.prototype.count = undefined;
 ...
 */
KubernetesNodePool.prototype.taints = undefined;

/**
 * A boolean value indicating whether auto-scaling is enabled for this node pool.
 * @member {Boolean} autoScale
 */
KubernetesNodePool.prototype.autoScale = undefined;
 ...
 */
KubernetesNodePool.prototype.minNodes = undefined;
