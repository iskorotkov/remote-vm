...
export class VolumeBase {
  /**
   * Constructs a new <code>VolumeBase</code>.
   * @alias module:model/VolumeBase
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new VolumeBase();
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('droplet_ids'))
        obj.dropletIds = ApiClient.convertToType(data['droplet_ids'], ['Number']);
 ...
 * @member {String} id
 */
VolumeBase.prototype.id = undefined;
 ...
 */
VolumeBase.prototype.dropletIds = undefined;
 ...
 * @member {String} name
 */
VolumeBase.prototype.name = undefined;

/**
 * An optional free-form text field to describe a block storage volume.
 * @member {String} description
 */
VolumeBase.prototype.description = undefined;

/**
 * The size of the block storage volume in GiB (1024^3).
 * @member {Number} sizeGigabytes
 */
VolumeBase.prototype.sizeGigabytes = undefined;
 ...
 */
VolumeBase.prototype.createdAt = undefined;

/**
 * @member {module:model/TagsArray} tags
 */
VolumeBase.prototype.tags = undefined;
