...
export class DatabaseCluster {
   ...
   */
  constructor(name, engine, numNodes, size, region) {
    this.name = name;
    this.engine = engine;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('num_nodes'))
        obj.numNodes = ApiClient.convertToType(data['num_nodes'], 'Number');
      ...
      if (data.hasOwnProperty('private_network_uuid'))
        obj.privateNetworkUuid = ApiClient.convertToType(data['private_network_uuid'], 'String');
      if (data.hasOwnProperty('tags'))
        obj.tags = ApiClient.convertToType(data['tags'], ['String']);
      if (data.hasOwnProperty('db_names'))
        obj.dbNames = ApiClient.convertToType(data['db_names'], ['String']);
      if (data.hasOwnProperty('connection'))
        obj.connection = ApiClient.convertToType(data['connection'], Object);
      if (data.hasOwnProperty('private_connection'))
        obj.privateConnection = ApiClient.convertToType(data['private_connection'], Object);
      if (data.hasOwnProperty('users'))
        obj.users = ApiClient.convertToType(data['users'], [DatabaseUser]);
      if (data.hasOwnProperty('maintenance_window'))
        obj.maintenanceWindow = ApiClient.convertToType(data['maintenance_window'], Object);
    }
    return obj;
  }
}
 ...
 * @member {module:model/DatabaseCluster.EngineEnum} engine
 */
DatabaseCluster.prototype.engine = undefined;

/**
 * A string representing the version of the database engine in use for the cluster.
 * @member {String} version
 */
DatabaseCluster.prototype.version = undefined;

/**
 * The number of nodes in the database cluster.
 * @member {Number} numNodes
 */
DatabaseCluster.prototype.numNodes = undefined;

/**
 * The slug identifier representing the size of the nodes in the database cluster.
 * @member {String} size
 */
DatabaseCluster.prototype.size = undefined;

/**
 * The slug identifier for the region where the database cluster is located.
 * @member {String} region
 */
DatabaseCluster.prototype.region = undefined;
 ...
 */
DatabaseCluster.prototype.createdAt = undefined;
 ...
 */
DatabaseCluster.prototype.privateNetworkUuid = undefined;

/**
 * An array of tags that have been applied to the database cluster.
 * @member {Array.<String>} tags
 */
DatabaseCluster.prototype.tags = undefined;

/**
 * An array of strings containing the names of databases created in the database cluster.
 * @member {Array.<String>} dbNames
 */
DatabaseCluster.prototype.dbNames = undefined;

/**
 * @member {Object} connection
 */
DatabaseCluster.prototype.connection = undefined;

/**
 * @member {Object} privateConnection
 */
DatabaseCluster.prototype.privateConnection = undefined;

/**
 * @member {Array.<module:model/DatabaseUser>} users
 */
DatabaseCluster.prototype.users = undefined;

/**
 * @member {Object} maintenanceWindow
 */
DatabaseCluster.prototype.maintenanceWindow = undefined;
