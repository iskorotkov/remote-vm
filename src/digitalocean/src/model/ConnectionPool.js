...
export class ConnectionPool {
   ...
   */
  constructor(name, mode, size, db, user) {
    this.name = name;
    this.mode = mode;
    this.size = size;
    this.db = db;
 ...
 * @member {String} name
 */
ConnectionPool.prototype.name = undefined;

/**
 * The PGBouncer transaction mode for the connection pool. The allowed values are session, transaction, and statement.
 * @member {String} mode
 */
ConnectionPool.prototype.mode = undefined;
 ...
 * @member {Number} size
 */
ConnectionPool.prototype.size = undefined;

/**
 * The database for use with the connection pool.
 * @member {String} db
 */
ConnectionPool.prototype.db = undefined;

/**
 * The name of the user for use with the connection pool.
 * @member {String} user
 */
ConnectionPool.prototype.user = undefined;

/**
 * @member {Object} connection
 */
ConnectionPool.prototype.connection = undefined;

/**
 * @member {Object} privateConnection
 */
ConnectionPool.prototype.privateConnection = undefined;
