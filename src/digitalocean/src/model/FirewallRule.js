...
export class FirewallRule {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cluster_uuid'))
        obj.clusterUuid = ApiClient.convertToType(data['cluster_uuid'], 'String');
 ...
 * @member {module:model/FirewallRule.TypeEnum} type
 */
