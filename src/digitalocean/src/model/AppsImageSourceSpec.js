...
export class AppsImageSourceSpec {
  /**
   * Constructs a new <code>AppsImageSourceSpec</code>.
   * @alias module:model/AppsImageSourceSpec
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppsImageSourceSpec();
      ...
      if (data.hasOwnProperty('registry_type'))
        obj.registryType = ApiClient.convertToType(data['registry_type'], 'String');
 ...
 */
AppsImageSourceSpec.prototype.registry = undefined;

/**
 * Allowed values for the <code>registryType</code> property.
 * @enum {String}
 * @readonly
 */
AppsImageSourceSpec.RegistryTypeEnum = {
  /**
   * value: "DOCKER_HUB"
   * @const
   */
 ...
 */
AppsImageSourceSpec.prototype.registryType = undefined;

/**
 * The repository name.
 * @member {String} repository
 */
AppsImageSourceSpec.prototype.repository = undefined;
 ...
 * @default 'latest'
 */
AppsImageSourceSpec.prototype.tag = 'latest';
