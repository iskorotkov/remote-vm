...
export class InvoiceItem {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resource_uuid'))
        obj.resourceUuid = ApiClient.convertToType(data['resource_uuid'], 'String');
      if (data.hasOwnProperty('resource_id'))
        obj.resourceId = ApiClient.convertToType(data['resource_id'], 'String');
      if (data.hasOwnProperty('group_description'))
        obj.groupDescription = ApiClient.convertToType(data['group_description'], 'String');
      ...
      if (data.hasOwnProperty('duration_unit'))
        obj.durationUnit = ApiClient.convertToType(data['duration_unit'], 'String');
 ...
 */
InvoiceItem.prototype.groupDescription = undefined;
