...
export class DatabaseUser {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('mysql_settings'))
        obj.mysqlSettings = MysqlSettings.constructFromObject(data['mysql_settings']);
    }
    return obj;
  }
}
 ...
 * @member {String} name
 */
DatabaseUser.prototype.name = undefined;
 ...
 */
DatabaseUser.prototype.role = undefined;

/**
 * A randomly generated password for the database user.
 * @member {String} password
 */
DatabaseUser.prototype.password = undefined;

/**
 * @member {module:model/MysqlSettings} mysqlSettings
 */
DatabaseUser.prototype.mysqlSettings = undefined;
