...
export class AppComponentInstanceBase {
  /**
   * Constructs a new <code>AppComponentInstanceBase</code>.
   * @alias module:model/AppComponentInstanceBase
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppComponentInstanceBase();
 ...
 * @default 1
 */
AppComponentInstanceBase.prototype.instanceCount = 1;
 ...
 * @readonly
 */
AppComponentInstanceBase.InstanceSizeSlugEnum = {
  /**
   * value: "basic-xxs"
   * @const
   */
 ...
 * @default 'basic-xxs'
 */
AppComponentInstanceBase.prototype.instanceSizeSlug = 'basic-xxs';
