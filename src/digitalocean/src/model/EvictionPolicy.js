...
export class EvictionPolicy {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EvictionPolicy();
      if (data.hasOwnProperty('eviction_policy'))
        obj.evictionPolicy = ApiClient.convertToType(data['eviction_policy'], 'String');
    }
    return obj;
  }
}
 ...
 * @readonly
 */
EvictionPolicy.EvictionPolicyEnum = {
  /**
   * value: "noeviction"
   * @const
   */
 ...
 * @member {module:model/EvictionPolicy.EvictionPolicyEnum} evictionPolicy
 */
EvictionPolicy.prototype.evictionPolicy = undefined;
