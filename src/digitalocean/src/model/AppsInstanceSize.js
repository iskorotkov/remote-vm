...
import {InstanceSizeCpuType} from './InstanceSizeCpuType';
...
export class AppsInstanceSize {
  /**
   * Constructs a new <code>AppsInstanceSize</code>.
   * @alias module:model/AppsInstanceSize
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppsInstanceSize();
      if (data.hasOwnProperty('cpu_type'))
        obj.cpuType = InstanceSizeCpuType.constructFromObject(data['cpu_type']);
      if (data.hasOwnProperty('cpus'))
        obj.cpus = ApiClient.convertToType(data['cpus'], 'String');
      if (data.hasOwnProperty('memory_bytes'))
        obj.memoryBytes = ApiClient.convertToType(data['memory_bytes'], 'String');
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('slug'))
        obj.slug = ApiClient.convertToType(data['slug'], 'String');
      if (data.hasOwnProperty('tier_downgrade_to'))
        obj.tierDowngradeTo = ApiClient.convertToType(data['tier_downgrade_to'], 'String');
      if (data.hasOwnProperty('tier_slug'))
        obj.tierSlug = ApiClient.convertToType(data['tier_slug'], 'String');
      if (data.hasOwnProperty('tier_upgrade_to'))
        obj.tierUpgradeTo = ApiClient.convertToType(data['tier_upgrade_to'], 'String');
      if (data.hasOwnProperty('usd_per_month'))
        obj.usdPerMonth = ApiClient.convertToType(data['usd_per_month'], 'String');
      if (data.hasOwnProperty('usd_per_second'))
        obj.usdPerSecond = ApiClient.convertToType(data['usd_per_second'], 'String');
    }
    return obj;
  }
}
 ...
 */
AppsInstanceSize.prototype.cpuType = undefined;

/**
 * @member {String} cpus
 */
AppsInstanceSize.prototype.cpus = undefined;

/**
 * @member {String} memoryBytes
 */
AppsInstanceSize.prototype.memoryBytes = undefined;

/**
 * @member {String} name
 */
AppsInstanceSize.prototype.name = undefined;

/**
 * @member {String} slug
 */
AppsInstanceSize.prototype.slug = undefined;

/**
 * @member {String} tierDowngradeTo
 */
AppsInstanceSize.prototype.tierDowngradeTo = undefined;

/**
 * @member {String} tierSlug
 */
AppsInstanceSize.prototype.tierSlug = undefined;

/**
 * @member {String} tierUpgradeTo
 */
AppsInstanceSize.prototype.tierUpgradeTo = undefined;

/**
 * @member {String} usdPerMonth
 */
AppsInstanceSize.prototype.usdPerMonth = undefined;

/**
 * @member {String} usdPerSecond
 */
AppsInstanceSize.prototype.usdPerSecond = undefined;
