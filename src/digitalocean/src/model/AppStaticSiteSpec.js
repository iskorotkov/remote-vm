...
export class AppStaticSiteSpec extends AppComponentBase {
  ...
  /**
   * Constructs a <code>AppStaticSiteSpec</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppStaticSiteSpec} obj Optional instance to populate.
   * @return {module:model/AppStaticSiteSpec} The populated <code>AppStaticSiteSpec</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppStaticSiteSpec();
      AppComponentBase.constructFromObject(data, obj);
      if (data.hasOwnProperty('index_document'))
        obj.indexDocument = ApiClient.convertToType(data['index_document'], 'String');
      if (data.hasOwnProperty('error_document'))
        obj.errorDocument = ApiClient.convertToType(data['error_document'], 'String');
      if (data.hasOwnProperty('catchall_document'))
        obj.catchallDocument = ApiClient.convertToType(data['catchall_document'], 'String');
      if (data.hasOwnProperty('output_dir'))
        obj.outputDir = ApiClient.convertToType(data['output_dir'], 'String');
 ...
 * @default 'index.html'
 */
AppStaticSiteSpec.prototype.indexDocument = 'index.html';
 ...
 * @default '404.html'
 */
AppStaticSiteSpec.prototype.errorDocument = '404.html';
 ...
 */
AppStaticSiteSpec.prototype.catchallDocument = undefined;
