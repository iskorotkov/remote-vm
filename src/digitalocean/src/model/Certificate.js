  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('not_after'))
        obj.notAfter = ApiClient.convertToType(data['not_after'], 'Date');
      if (data.hasOwnProperty('sha1_fingerprint'))
        obj.sha1Fingerprint = ApiClient.convertToType(data['sha1_fingerprint'], 'String');
 ...
 */
Certificate.prototype.dnsNames = undefined;
