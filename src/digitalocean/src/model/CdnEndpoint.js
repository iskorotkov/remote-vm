 ...
 * @member {String} id
 */
CdnEndpoint.prototype.id = undefined;
 ...
 */
CdnEndpoint.prototype.origin = undefined;

/**
 * The fully qualified domain name (FQDN) from which the CDN-backed content is served.
 * @member {String} endpoint
 */
CdnEndpoint.prototype.endpoint = undefined;

/**
 * Allowed values for the <code>ttl</code> property.
 * @enum {Number}
 * @readonly
 */
CdnEndpoint.TtlEnum = {
