  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('name'))
        obj.name = ImageName.constructFromObject(data['name']);
      ...
      if (data.hasOwnProperty('regions'))
        obj.regions = RegionsArray.constructFromObject(data['regions']);
      ...
      if (data.hasOwnProperty('description'))
        obj.description = ImageDescription.constructFromObject(data['description']);
      if (data.hasOwnProperty('tags'))
        obj.tags = TagsArray.constructFromObject(data['tags']);
 ...
 */
Image.prototype.distribution = undefined;
 ...
 * @member {String} slug
 */
Image.prototype.slug = undefined;
 ...
 */
Image.prototype._public = undefined;
 ...
 */
Image.prototype.minDiskSize = undefined;

/**
 * The size of the image in gigabytes.
 * @member {Number} sizeGigabytes
 */
Image.prototype.sizeGigabytes = undefined;
 ...
 */
Image.prototype.errorMessage = undefined;
