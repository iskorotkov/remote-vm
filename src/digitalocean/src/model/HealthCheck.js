  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('check_interval_seconds'))
        obj.checkIntervalSeconds = ApiClient.convertToType(data['check_interval_seconds'], 'Number');
      if (data.hasOwnProperty('response_timeout_seconds'))
        obj.responseTimeoutSeconds = ApiClient.convertToType(data['response_timeout_seconds'], 'Number');
      if (data.hasOwnProperty('unhealthy_threshold'))
        obj.unhealthyThreshold = ApiClient.convertToType(data['unhealthy_threshold'], 'Number');
      if (data.hasOwnProperty('healthy_threshold'))
        obj.healthyThreshold = ApiClient.convertToType(data['healthy_threshold'], 'Number');
    }
    return obj;
  }
}
 ...
 * @default 'http'
 */
HealthCheck.prototype.protocol = 'http';
 ...
 * @default 10
 */
HealthCheck.prototype.checkIntervalSeconds = 10;
 ...
 * @default 5
 */
HealthCheck.prototype.responseTimeoutSeconds = 5;
 ...
 * @default 5
 */
HealthCheck.prototype.unhealthyThreshold = 5;
 ...
 * @default 3
 */
HealthCheck.prototype.healthyThreshold = 3;
