...
/**
 * The AllOfdatabaseReplicaConnection model module.
 * @module model/AllOfdatabaseReplicaConnection
 * @version 2.0
 */
export class AllOfdatabaseReplicaConnection {
  /**
   * Constructs a new <code>AllOfdatabaseReplicaConnection</code>.
   * @alias module:model/AllOfdatabaseReplicaConnection
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>AllOfdatabaseReplicaConnection</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfdatabaseReplicaConnection} obj Optional instance to populate.
   * @return {module:model/AllOfdatabaseReplicaConnection} The populated <code>AllOfdatabaseReplicaConnection</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfdatabaseReplicaConnection();
 ...
 * @member {String} uri
 */
AllOfdatabaseReplicaConnection.prototype.uri = undefined;

/**
 * The name of the default database.
 * @member {String} database
 */
AllOfdatabaseReplicaConnection.prototype.database = undefined;

/**
 * The FQDN pointing to the database cluster's current primary node.
 * @member {String} host
 */
AllOfdatabaseReplicaConnection.prototype.host = undefined;

/**
 * The port on which the database cluster is listening.
 * @member {Number} port
 */
AllOfdatabaseReplicaConnection.prototype.port = undefined;

/**
 * The default user for the database.
 * @member {String} user
 */
AllOfdatabaseReplicaConnection.prototype.user = undefined;

/**
 * The randomly generated password for the default user.
 * @member {String} password
 */
AllOfdatabaseReplicaConnection.prototype.password = undefined;

/**
 * A boolean value indicating if the connection should be made over SSL.
 * @member {Boolean} ssl
 */
AllOfdatabaseReplicaConnection.prototype.ssl = undefined;
