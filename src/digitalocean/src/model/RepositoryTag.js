...
export class RepositoryTag {
  /**
   * Constructs a new <code>RepositoryTag</code>.
   * @alias module:model/RepositoryTag
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RepositoryTag();
      if (data.hasOwnProperty('registry_name'))
        obj.registryName = ApiClient.convertToType(data['registry_name'], 'String');
      ...
      if (data.hasOwnProperty('manifest_digest'))
        obj.manifestDigest = ApiClient.convertToType(data['manifest_digest'], 'String');
      if (data.hasOwnProperty('compressed_size_bytes'))
        obj.compressedSizeBytes = ApiClient.convertToType(data['compressed_size_bytes'], 'Number');
      if (data.hasOwnProperty('size_bytes'))
        obj.sizeBytes = ApiClient.convertToType(data['size_bytes'], 'Number');
 ...
 */
RepositoryTag.prototype.registryName = undefined;

/**
 * The name of the repository.
 * @member {String} repositoryName
 */
RepositoryTag.prototype.repositoryName = undefined;

/**
 * The name of the tag.
 * @member {String} tag
 */
RepositoryTag.prototype.tag = undefined;

/**
 * The digest of the manifest associated with the tag.
 * @member {String} manifestDigest
 */
RepositoryTag.prototype.manifestDigest = undefined;

/**
 * The compressed size of the tag in bytes.
 * @member {Number} compressedSizeBytes
 */
RepositoryTag.prototype.compressedSizeBytes = undefined;
 ...
 */
RepositoryTag.prototype.sizeBytes = undefined;

/**
 * The time the tag was last updated.
 * @member {Date} updatedAt
 */
RepositoryTag.prototype.updatedAt = undefined;
