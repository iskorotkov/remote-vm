...
export class VolumeAction {
  /**
   * Constructs a new <code>VolumeAction</code>.
   * @alias module:model/VolumeAction
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resource_id'))
        obj.resourceId = ApiClient.convertToType(data['resource_id'], 'Number');
      ...
      if (data.hasOwnProperty('region_slug'))
        obj.regionSlug = ApiClient.convertToType(data['region_slug'], Object);
    }
    return obj;
  }
}
 ...
 * @member {Number} id
 */
VolumeAction.prototype.id = undefined;
 ...
 * @default 'in-progress'
 */
VolumeAction.prototype.status = 'in-progress';

/**
 * This is the type of action that the object represents. For example, this could be \"transfer\" to represent the state of an image transfer action.
 * @member {String} type
 */
VolumeAction.prototype.type = undefined;

/**
 * A time value given in ISO8601 combined date and time format that represents when the action was initiated.
 * @member {Date} startedAt
 */
VolumeAction.prototype.startedAt = undefined;

/**
 * A time value given in ISO8601 combined date and time format that represents when the action was completed.
 * @member {Date} completedAt
 */
VolumeAction.prototype.completedAt = undefined;

/**
 * A unique identifier for the resource that the action is associated with.
 * @member {Number} resourceId
 */
VolumeAction.prototype.resourceId = undefined;

/**
 * The type of resource that the action is associated with.
 * @member {String} resourceType
 */
VolumeAction.prototype.resourceType = undefined;

/**
 * @member {module:model/Region} region
 */
VolumeAction.prototype.region = undefined;

/**
 * @member {Object} regionSlug
 */
VolumeAction.prototype.regionSlug = undefined;
