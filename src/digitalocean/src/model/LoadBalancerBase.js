...
export class LoadBalancerBase {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('forwarding_rules'))
        obj.forwardingRules = ApiClient.convertToType(data['forwarding_rules'], [ForwardingRule]);
      if (data.hasOwnProperty('health_check'))
        obj.healthCheck = HealthCheck.constructFromObject(data['health_check']);
      if (data.hasOwnProperty('sticky_sessions'))
        obj.stickySessions = StickySessions.constructFromObject(data['sticky_sessions']);
      if (data.hasOwnProperty('redirect_http_to_https'))
        obj.redirectHttpToHttps = ApiClient.convertToType(data['redirect_http_to_https'], 'Boolean');
      if (data.hasOwnProperty('enable_proxy_protocol'))
        obj.enableProxyProtocol = ApiClient.convertToType(data['enable_proxy_protocol'], 'Boolean');
      if (data.hasOwnProperty('enable_backend_keepalive'))
        obj.enableBackendKeepalive = ApiClient.convertToType(data['enable_backend_keepalive'], 'Boolean');
 ...
 * @member {String} id
 */
LoadBalancerBase.prototype.id = undefined;

/**
 * A human-readable name for a load balancer instance.
 * @member {String} name
 */
LoadBalancerBase.prototype.name = undefined;

/**
 * An attribute containing the public-facing IP address of the load balancer.
 * @member {String} ip
 */
LoadBalancerBase.prototype.ip = undefined;
 ...
 * @default 'lb-small'
 */
LoadBalancerBase.prototype.size = 'lb-small';
 ...
 * @readonly
 */
LoadBalancerBase.AlgorithmEnum = {
  /**
   * value: "round_robin"
   * @const
   */
 ...
 * @default 'round_robin'
 */
LoadBalancerBase.prototype.algorithm = 'round_robin';
 ...
 * @default false
 */
LoadBalancerBase.prototype.redirectHttpToHttps = false;
 ...
 * @default false
 */
LoadBalancerBase.prototype.enableProxyProtocol = false;
 ...
 * @default false
 */
LoadBalancerBase.prototype.enableBackendKeepalive = false;

/**
 * A string specifying the UUID of the VPC to which the load balancer is assigned.
 * @member {String} vpcUuid
 */
LoadBalancerBase.prototype.vpcUuid = undefined;
