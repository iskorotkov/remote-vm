...
export class AllOfinvoiceSummaryUserBillingAddress {
  /**
   * Constructs a new <code>AllOfinvoiceSummaryUserBillingAddress</code>.
   * @alias module:model/AllOfinvoiceSummaryUserBillingAddress
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfinvoiceSummaryUserBillingAddress();
      ...
      if (data.hasOwnProperty('country_iso2_code'))
        obj.countryIso2Code = ApiClient.convertToType(data['country_iso2_code'], 'String');
 ...
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.addressLine1 = undefined;

/**
 * Street address line 2
 * @member {String} addressLine2
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.addressLine2 = undefined;

/**
 * City
 * @member {String} city
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.city = undefined;

/**
 * Region
 * @member {String} region
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.region = undefined;

/**
 * Postal code
 * @member {String} postalCode
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.postalCode = undefined;

/**
 * Country (ISO2) code
 * @member {String} countryIso2Code
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.countryIso2Code = undefined;

/**
 * Timestamp billing address was created
 * @member {String} createdAt
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.createdAt = undefined;

/**
 * Timestamp billing address was updated
 * @member {String} updatedAt
 */
AllOfinvoiceSummaryUserBillingAddress.prototype.updatedAt = undefined;
