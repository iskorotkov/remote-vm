...
export class ForwardingRule {
   ...
   */
  constructor(entryProtocol, entryPort, targetProtocol, targetPort) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('entry_protocol'))
        obj.entryProtocol = ApiClient.convertToType(data['entry_protocol'], 'String');
      if (data.hasOwnProperty('entry_port'))
        obj.entryPort = ApiClient.convertToType(data['entry_port'], 'Number');
      if (data.hasOwnProperty('target_protocol'))
        obj.targetProtocol = ApiClient.convertToType(data['target_protocol'], 'String');
      if (data.hasOwnProperty('target_port'))
        obj.targetPort = ApiClient.convertToType(data['target_port'], 'Number');
      if (data.hasOwnProperty('certificate_id'))
        obj.certificateId = ApiClient.convertToType(data['certificate_id'], 'String');
      if (data.hasOwnProperty('tls_passthrough'))
        obj.tlsPassthrough = ApiClient.convertToType(data['tls_passthrough'], 'Boolean');
    }
    return obj;
  }
}
...
/**
 * Allowed values for the <code>entryProtocol</code> property.
 * @enum {String}
 * @readonly
 */
ForwardingRule.EntryProtocolEnum = {
  /**
   * value: "http"
   * @const
   */
 ...
 * @member {module:model/ForwardingRule.EntryProtocolEnum} entryProtocol
 */
ForwardingRule.prototype.entryProtocol = undefined;

/**
 * An integer representing the port on which the load balancer instance will listen.
 * @member {Number} entryPort
 */
ForwardingRule.prototype.entryPort = undefined;

/**
 * Allowed values for the <code>targetProtocol</code> property.
 * @enum {String}
 * @readonly
 */
ForwardingRule.TargetProtocolEnum = {
  /**
   * value: "http"
   * @const
   */
 ...
 * @member {module:model/ForwardingRule.TargetProtocolEnum} targetProtocol
 */
ForwardingRule.prototype.targetProtocol = undefined;

/**
 * An integer representing the port on the backend Droplets to which the load balancer will send traffic.
 * @member {Number} targetPort
 */
ForwardingRule.prototype.targetPort = undefined;

/**
 * The ID of the TLS certificate used for SSL termination if enabled.
 * @member {String} certificateId
 */
ForwardingRule.prototype.certificateId = undefined;
 ...
 */
ForwardingRule.prototype.tlsPassthrough = undefined;
