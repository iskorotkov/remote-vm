...
export class AppJobSpec extends AppComponentBase {
  ...
  /**
   * Constructs a <code>AppJobSpec</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppJobSpec} obj Optional instance to populate.
   * @return {module:model/AppJobSpec} The populated <code>AppJobSpec</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AppJobSpec();
 ...
 * @default 1
 */
AppJobSpec.prototype.instanceCount = 1;
 ...
 * @readonly
 */
AppJobSpec.InstanceSizeSlugEnum = {
  /**
   * value: "basic-xxs"
   * @const
   */
 ...
 * @default 'basic-xxs'
 */
AppJobSpec.prototype.instanceSizeSlug = 'basic-xxs';
 ...
 * @default 'UNSPECIFIED'
 */
AppJobSpec.prototype.kind = 'UNSPECIFIED';
