...
export class ApiClient {
    ...
    */
    callApi(path: string, httpMethod: string, pathParams: any, queryParams: any, headerParams: any, formParams: any, bodyParam: any, authNames: Array<string>, contentTypes: Array<string>, accepts: Array<string>, returnType: (string | any[] | any), callback: any): any;
}
export namespace ApiClient {
    const instance: any;
}
/**
 * :ApiClient~callApiCallback
 */
export type module = (error: string, data: any, response: string) => any;
